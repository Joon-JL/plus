...
* File Name : CustomerForm.java
* Description : 계약거래처 Form
* Author : dawn
* Date : 2011.09.29
...
public class CustomerTestForm extends CommonForm {
	
	private String isModify; // 2012-05-15 추가
	...
	private String selectCnt;//Multi 선택 시 selectList Count.
	private String selectRow;//Multi 선택 시 selectList Count.
	private String[] spanIdx;//span Index
	...
	public String[] getHp_nos() {
		return hp_nos;
	}
	public void setHp_nos(String[] hp_nos) {
		this.hp_nos = hp_nos;
	}
	...
	public String[] getSpanIdx() {
		return spanIdx;
	}
	public void setSpanIdx(String[] spanIdx) {
