...
public class StatisticsVO extends CommonVO {
	...
	private String srch_grp_cd ; // 공통코드 GRP_CD
	private String srch_useman_mng_itm1 ; // 공통코드 USEMAN_MNG_ITM1
	...
	private String elUserlYn;	//전자검토자여부	
	...
	public void setSort_yn(String sort_yn) {
		this.sort_yn = sort_yn;
	}
	...
	public String getSrch_grp_cd() {
		return srch_grp_cd;
	}
	public void setSrch_grp_cd(String srch_grp_cd) {
		this.srch_grp_cd = srch_grp_cd;
	}
	public String getSrch_useman_mng_itm1() {
		return srch_useman_mng_itm1;
	}
	public void setSrch_useman_mng_itm1(String srch_useman_mng_itm1) {
		this.srch_useman_mng_itm1 = srch_useman_mng_itm1;
	}
