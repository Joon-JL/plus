 ...
 * Date			: 2011. 08. 05
 */
public class SpeakConsultServiceImpl extends CommonServiceImpl implements SpeakConsultService {
...
//	}
	 ...
	 * List 출력
	 */
	public List listSpeakConsult(SpeakConsultVO vo) throws Exception {
		...
		return commonDAO.list("las.speakconsult.list", vo);
	}
	 ...
	 */
	public int insertSpeakConsult(SpeakConsultVO vo) throws Exception {
		
		//seqno 세팅
		//vo.setSeqno(idGenerationService.getNextIntegerId());
		
		ListOrderedMap maxseqLom = (ListOrderedMap) commonDAO.list("las.speakconsult.maxseq",vo).get(0);
...
//		}
		...
		return commonDAO.insert("las.speakconsult.insert", vo);
	}
	 ...
	 * 수정
	 */
	public int modifySpeakConsult(SpeakConsultVO vo) throws Exception {
...
//		}
		...
		return commonDAO.modify("las.speakconsult.modify", vo);
	}

	/**
	 * 삭제
	 */
	public int deleteSpeakConsult(SpeakConsultVO vo) throws Exception {
		
		//삭제자 정보 세션에서 받아와 vo에 세팅
		vo.setDel_nm(vo.getSession_user_nm());
		vo.setDel_id(vo.getSession_user_id());
		
		 return commonDAO.delete("las.speakconsult.delete", vo);
	}

	/**
	 * 상세보기
	 */
	public ListOrderedMap detailSpeakConsult(SpeakConsultVO vo) throws Exception {
		
		//상세조회할 데이터를 불러온다
		List list = commonDAO.list("las.speakconsult.detail", vo);
	 ...
	 * @throws Exception
	 */
	public void convertHtmlTochars(SpeakConsultVO vo) throws Exception {
	 ...
	 * @throws Exception
	 */
	public String getUpMenuId(SpeakConsultVO vo) throws Exception {
