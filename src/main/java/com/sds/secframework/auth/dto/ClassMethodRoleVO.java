...
public class ClassMethodRoleVO extends CommonVO {
	/**
	 * 시스템코드
	 */
	...
	private String[] available_role_list;
	
	private String[] assigned_role_list;
	
	private String[] checkbox;
	
	public ClassMethodRoleVO(){
		super();
		sys_cd = "SHRI";
		srch_type = "ALL";
	}
	...
	public String[] getAvailable_role_list() {
		return available_role_list;
	}

	public void setAvailable_role_list(String[] available_role_list) {
		this.available_role_list = available_role_list;
	}

	public String[] getAssigned_role_list() {
		return assigned_role_list;
	}

	public void setAssigned_role_list(String[] assigned_role_list) {
