...
public class ClassMethodAuthForm extends CommonVO {
	/**
	 * 시스템코드
	 */
	 ...
	 * 클래스 메소드 리스트
	 */
	private List class_method_auth_list;
	
	/**
	 * 설정가능한 권한 리스트
	 */
	private List available_auth_list;
	
	
	/**
	 * 설정된 권한 리스트
	 */
	private List assigned_auth_list;
	...
	public List getAvailable_auth_list() {
		return available_auth_list;
	}

	public void setAvailable_auth_list(List available_auth_list) {
		this.available_auth_list = available_auth_list;
	}

	public List getAssigned_auth_list() {
		return assigned_auth_list;
	}

	public void setAssigned_auth_list(List assigned_auth_list) {
	...
	public List getClass_method_auth_list() {
		return class_method_auth_list;
	}

	public void setClass_method_auth_list(List class_method_auth_list) {
		this.class_method_auth_list = class_method_auth_list;
	}
