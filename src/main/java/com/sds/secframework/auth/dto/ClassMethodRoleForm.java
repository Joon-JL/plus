...
public class ClassMethodRoleForm extends CommonVO {
	/**
	 * 시스템코드
	 */
	 ...
	 * 클래스 메소드 리스트
	 */
	private List class_method_role_list;
	
	/**
	 * 설정가능한 권한 리스트
	 */
	private List available_role_list;
	
	
	/**
	 * 설정된 권한 리스트
	 */
	private List assigned_role_list;
	...
	public List getAvailable_role_list() {
		return available_role_list;
	}

	public void setAvailable_role_list(List available_role_list) {
		this.available_role_list = available_role_list;
	}

	public List getAssigned_role_list() {
		return assigned_role_list;
	}

	public void setAssigned_role_list(List assigned_role_list) {
		this.assigned_role_list = assigned_role_list;
	}
	...
	public List getClass_method_role_list() {
		return class_method_role_list;
	}

	public void setClass_method_role_list(List class_method_role_list) {
		this.class_method_role_list = class_method_role_list;
	}
