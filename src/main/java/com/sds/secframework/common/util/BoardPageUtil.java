 ...
 * </pre>
 */
public class BoardPageUtil implements Serializable{

	public BoardPageUtil() {
	}
	
	public BoardPageUtil(int totalRow, int rowPerPage, int thisPage){
    ...
    public String getPageNavi(BoardPageUtil boardPageUtil, String sContext){
        ...
        String sFirstImage = sPrefix + "/images/shri/btn/page-first.gif";
        String sPrevImage  = sPrefix + "/images/shri/btn/page-prev.gif";
        String sNextImage  = sPrefix + "/images/shri/btn/page-next.gif";
        String sLastImage  = sPrefix + "/images/shri/btn/page-last.gif";
    	
    	if(boardPageUtil.getTotalRow() > 0) {
	    	long nowPage = boardPageUtil.getThisPage();
			long prevPage = 0, nextPage = 0, pagingStart = 0, pagingEnd = 0;
								
			if(nowPage > 1) prevPage = nowPage - 1;
				else prevPage = 1;
			if(nowPage < boardPageUtil.getTotalPage()) nextPage = nowPage + 1;
				else nextPage = nowPage;
								
			pagingStart = ((nowPage-1)/10)*10 + 1;
			pagingEnd = (boardPageUtil.getTotalPage() < pagingStart + 9 ? boardPageUtil.getTotalPage() : pagingStart+9);
			...
			pageString.append("<a href=\"javascript:goPage(" + boardPageUtil.getTotalPage() + ")\" class=\"end\"><img src='" + sLastImage + "'></a>");
    ...
    public String getPageNavi(BoardPageUtil boardPageUtil, String sContext, String langCode){
        ...
        /*String sFirstImage = sPrefix + "/images/shri/"+langCode+"/btn/page-first.gif";
        String sPrevImage  = sPrefix + "/images/shri/"+langCode+"/btn/page-prev.gif";
        String sNextImage  = sPrefix + "/images/shri/"+langCode+"/btn/page-next.gif";
        String sLastImage  = sPrefix + "/images/shri/"+langCode+"/btn/page-last.gif";*/
    ...
    public String getCpisPageNavi(BoardPageUtil boardPageUtil, String sContext) {
    	...
    	if (boardPageUtil.getTotalRow() > 0) {
    		...
    		if (nowPage < boardPageUtil.getTotalPage()) {
    			nextPage = nowPage + 1;
    		}else {
    			nextPage = nowPage;
    		}
    		...
    		for (long i = pagingStart; i <= pagingEnd; i++) {
    			if (i == nowPage) {
    				...
    				if (boardPageUtil.getTotalPage() != i) {
    		...
    		pageString.append("<td><img src='" + sLastImage + "' onClick='javascript:goPage(" + boardPageUtil.getTotalPage() + ")'></td>");
