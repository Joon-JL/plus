...
public class ConsultationForm extends ConsiderationForm {
	...
	private String tmp_cntrt_oppnt_cd;
	private String tmp_region_gbn;
	private String tmp_cntrt_oppnt_nm;
	private String tmp_cntrt_oppnt_rprsntman;
	private String tmp_cntrt_oppnt_type;
	private String tmp_cntrt_oppnt_respman;
	private String tmp_cntrt_oppnt_telno;
	private String tmp_cntrt_oppnt_email;
	private String biz_clsfcn_nm;
	private String depth_clsfcn_nm;
	private String cnclsnpurps_bigclsfcn_nm;
	private String cnclsnpurps_midclsfcn_nm;
	...
	//의뢰시 타이틀 설정
	private String req_status_title;
	
	//임시저장 종류 flag(button, tap)
	private String tempsave_flag;
	
	//첨부파일 필수 사항 체크 최종본 인경우 만 사용 
	private String file_validate;
	
	// 체결 후 등록에 관련된 페이지 분기에 필요한 값
	...
	private String abbr_comp_nm;           // 회사 약어 명칭
	...
	public String getAbbr_comp_nm() {
		return abbr_comp_nm;
	}
	public void setAbbr_comp_nm(String abbr_comp_nm) {
		this.abbr_comp_nm = abbr_comp_nm;
	}
	...
	public String getReq_status_title() {
		return req_status_title;
	}
	public void setReq_status_title(String req_status_title) {
		this.req_status_title = req_status_title;
	}
	...
	public String getDepth_clsfcn_nm() {
		return depth_clsfcn_nm;
	}
	public void setDepth_clsfcn_nm(String depth_clsfcn_nm) {
		this.depth_clsfcn_nm = depth_clsfcn_nm;
	}
	public String getCnclsnpurps_bigclsfcn_nm() {
		return cnclsnpurps_bigclsfcn_nm;
	}
	public void setCnclsnpurps_bigclsfcn_nm(String cnclsnpurps_bigclsfcn_nm) {
		this.cnclsnpurps_bigclsfcn_nm = cnclsnpurps_bigclsfcn_nm;
	}
	public String getCnclsnpurps_midclsfcn_nm() {
		return cnclsnpurps_midclsfcn_nm;
	}
	public void setCnclsnpurps_midclsfcn_nm(String cnclsnpurps_midclsfcn_nm) {
	...
	public String getTmp_cntrt_oppnt_cd() {
		return tmp_cntrt_oppnt_cd;
	}
	public void setTmp_cntrt_oppnt_cd(String tmp_cntrt_oppnt_cd) {
		this.tmp_cntrt_oppnt_cd = tmp_cntrt_oppnt_cd;
	}
	public String getTmp_region_gbn() {
		return tmp_region_gbn;
	}
	public void setTmp_region_gbn(String tmp_region_gbn) {
		this.tmp_region_gbn = tmp_region_gbn;
	}
	public String getTmp_cntrt_oppnt_nm() {
		return tmp_cntrt_oppnt_nm;
	}
	public void setTmp_cntrt_oppnt_nm(String tmp_cntrt_oppnt_nm) {
		this.tmp_cntrt_oppnt_nm = tmp_cntrt_oppnt_nm;
	}
	public String getTmp_cntrt_oppnt_rprsntman() {
		return tmp_cntrt_oppnt_rprsntman;
	}
	public void setTmp_cntrt_oppnt_rprsntman(String tmp_cntrt_oppnt_rprsntman) {
		this.tmp_cntrt_oppnt_rprsntman = tmp_cntrt_oppnt_rprsntman;
	}
	public String getTmp_cntrt_oppnt_type() {
		return tmp_cntrt_oppnt_type;
	}
	public void setTmp_cntrt_oppnt_type(String tmp_cntrt_oppnt_type) {
		this.tmp_cntrt_oppnt_type = tmp_cntrt_oppnt_type;
	}
	public String getTmp_cntrt_oppnt_respman() {
		return tmp_cntrt_oppnt_respman;
	}
	public void setTmp_cntrt_oppnt_respman(String tmp_cntrt_oppnt_respman) {
		this.tmp_cntrt_oppnt_respman = tmp_cntrt_oppnt_respman;
	}
	public String getTmp_cntrt_oppnt_telno() {
		return tmp_cntrt_oppnt_telno;
	}
	public void setTmp_cntrt_oppnt_telno(String tmp_cntrt_oppnt_telno) {
		this.tmp_cntrt_oppnt_telno = tmp_cntrt_oppnt_telno;
	}
	public String getTmp_cntrt_oppnt_email() {
		return tmp_cntrt_oppnt_email;
	}
	public void setTmp_cntrt_oppnt_email(String tmp_cntrt_oppnt_email) {
		this.tmp_cntrt_oppnt_email = tmp_cntrt_oppnt_email;
	}
...
//	private String del_id;
	...
	public void getCntrt_oppnt_nation(String cntrt_oppnt_nation){
		this.cntrt_oppnt_nation = cntrt_oppnt_nation;
	}
