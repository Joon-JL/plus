...
public class ManageForm extends CommonForm {
	/**********************************************************************
	 * DB 변수
	 **********************************************************************/
	...
	private String srch_cntrt_no;              // 계약번호
	private String srch_cntrt_nm;              // 계약명
	...
	private String linkViewFlag;		// 타 시스템에서 링크로 오는 경우 MyContract의 List에서 상세조회 시 메뉴변경없이 처리하기 위한 구분
	...
	private String closed_yn;					// closed_yn : Regal Admin의 종료여부(구주 추가)
	...
	public String getLinkViewFlag() {
		return linkViewFlag;
	}
	public void setLinkViewFlag(String linkViewFlag) {
		this.linkViewFlag = linkViewFlag;
	}
