...
public class QnaForm extends CommonVO{
	...
	private String return_message;	//리턴메시지
	private boolean auth_transfer;	//이관 시 권한
	private boolean auth_reply;	//답변 시 권한
	...
	/* default 값 세팅 */
	public QnaForm() throws Exception {
	...
	public boolean isAuth_transfer() {
		return auth_transfer;
	}

	public void setAuth_transfer(boolean auth_transfer) {
		this.auth_transfer = auth_transfer;
	}
