 ...
 * File name	: SignManageForm.java
 * Description	: 날인 Data FORM(Model)
 * Author		: 박병주
 * Date			: 2013. 05
...
public class SignManageForm extends CommonForm {
	...
	public String getMakeHtml() {
		return makeHtml;
	}
	public void setMakeHtml(String makeHtml) {
	...
	public String getGo_pumui() {
		return go_pumui;
	}
	public void setGo_pumui(String go_pumui) {
		this.go_pumui = go_pumui;
	}
