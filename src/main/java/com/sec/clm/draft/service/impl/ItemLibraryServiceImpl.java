...
* File Name : ItemLibraryServiceImpl.java
* Description : 조항 라이브러리 ServiceImpl
* Author : 신남원
* Date : 2010.08.31
...
public class ItemLibraryServiceImpl extends CommonServiceImpl implements ItemLibraryService {
	...
	* @throws Exception
	*/
	public List listItemLibrary(LibraryVO vo) throws Exception {
		return commonDAO.list("clm.draft.listItemLibrary", vo);
	}
	...
	* @throws Exception
	*/
	public int insertItemLibrary(LibraryVO vo) throws Exception {
		//libNo 구하기
		int libNo = 1;
		List libnoList = null;
		
		libnoList = commonDAO.list("clm.draft.maxLibNoItemLibrary", vo);
		...
		//데이터 저장
		commonDAO.insert("clm.draft.insertItemLibrary", vo);
	...
	* @throws Exception
	*/
	public int modifyItemLibrary(LibraryVO vo) throws Exception {
		...
		commonDAO.modify("clm.draft.modifyItemLibrary", vo);
	...
	* @throws Exception
	*/
	public int deleteItemLibrary(LibraryVO vo) throws Exception {
		...
		return commonDAO.modify("clm.draft.deleteItemLibrary", vo);
	}
	...
	* @throws Exception
	*/
	public ListOrderedMap detailItemLibrary(LibraryVO vo) throws Exception {
		ListOrderedMap result = null;
		
		//데이터 조회
		List resultList = commonDAO.list("clm.draft.detailItemLibrary", vo);
		
		if(resultList != null && resultList.size() > 0){
			result = (ListOrderedMap)resultList.get(0);

			//조회수 증가
			commonDAO.modify("clm.draft.modifyRdcntItemLibrary", vo);
		}
	...
	* @throws Exception
	*/
	public boolean authItemLibrary(String mode, LibraryVO vo) throws Exception {
		...
		if(adminCheck){
			...
			List infoList = commonDAO.list("clm.draft.authItemLibrary",vo);
