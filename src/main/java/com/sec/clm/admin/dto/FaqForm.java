...
public class FaqForm extends CommonForm {
	/**********************************************************************
	 * DB 변수
	 **********************************************************************/
	private int seqno;
	...
	public String getSrch_cont_type() {
		return srch_cont_type;
	}

	public void setSrch_cont_type(String srch_cont_type) {
		this.srch_cont_type = srch_cont_type;
	}
