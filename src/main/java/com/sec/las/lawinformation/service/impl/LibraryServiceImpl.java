 ...
 * Date			: 2011. 08. 04
 */
public class LibraryServiceImpl extends CommonServiceImpl implements LibraryService {
	 ...
	 * @throws Exception
	 */
	public List listLibrary(LibraryVO vo) throws Exception {
		return commonDAO.list("las.contract.listLibrary", vo);
	}
	 ...
	 */
	public int insertLibrary(LibraryVO vo) throws Exception {
		
		//make sequence
		int seqno = 1;
		List resultList = null;
		
		resultList = commonDAO.list("las.contract.makeSeqLibrary", vo);
		...
		commonDAO.insert("las.contract.insertLibrary", vo);
	 ...
	 * @throws Exception
	 */
	public int modifyLibrary(LibraryVO vo) throws Exception {
		...
		return commonDAO.modify("las.contract.modifyLibrary", vo);
	}
	 ...
	 * @throws Exception
	 */
	public int deleteLibrary(LibraryVO vo) throws Exception {

		int result=0;
		result = commonDAO.delete("las.contract.deleteLibrary", vo);
	 ...
	 * @throws Exception
	 */
	public List getLibrary(LibraryVO vo) throws Exception {
		return commonDAO.list("las.contract.getLibrary", vo);
	}
	 ...
	 * @throws Exception
	 */
	public void increseRdcnt(LibraryVO vo) throws Exception {
		commonDAO.modify("las.contract.increseRdcnt", vo) ;
	}
	...
	* @throws Exception
	*/
	public boolean authLibrary(String mode, LibraryVO vo) throws Exception {
		boolean result = true;
		...
		if(!adminCheck){
			List infoList = commonDAO.list("las.lawinformation.authLibrary",vo);
	 ...
	 * @throws Exception
	 */
	public String checkAuthByRole(LibraryVO vo) throws Exception{
