...
public class PublicationForm extends CommonForm {
	/**********************************************
	 * 게시판설정(게시판명, 권한)
	 **********************************************/
	/**
	 ...
	 * @throws Exception
	 */
	public PublicationForm() throws Exception {
		board_nm = "사내외 주요 발간지";
	...
	public List getPublication_list() {
		return publication_list;
	}

	public void setPublication_list(List publication_list) {
		this.publication_list = publication_list;
	}
