...
function changeToday(id,target){
	...
	// Move the 'id' inside the makeDate function call
	$("#" + id + "_cal").html(makeDate(today[0],eval(today[1]-1), id));
...
function makeCal(id , tValue)
{
	 ...
	 cal_html += "<table width='100%'><tr><td><div class='divHead'><table class='calCss1'><tr><td id='"+ id +"_left' class='divHeadLeft' title='prev'>◀</td><td class='divHeadCenter'><select id='"+id+"_calYear'>";				 
	 ...
	 cal_html += "</select></td><td id='"+ id +"_right' class='divHeadRigth' title='next'>▶</td></tr></table></div></td></tr><tr><td><div id='" + id + "_cal" + "'>";			
