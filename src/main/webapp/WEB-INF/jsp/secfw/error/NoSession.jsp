...
<div class="alert_wrap">
  <div class="exp_box alert_width" style='width:520px;'>
    <div class="exp_box_in alert_height">
      <div class="alert_title"><%= "No Session" %></div>
      <ul class="alert_contents">
        <li class="img"></li>
        <li class="txt" style='width:370px;'>
          <spring:message code="secfw.page.field.alert.noSession" /><br />
    ...
    <div align="right" style='margin:10px'>
      <a href="<spring:message code="secfw.url.login" />"><img src="<c:url value='/images/secfw/common/btn_login.gif' />" border="0"></a>
    </div>
  </div>
</div>
<!-- footer -->
