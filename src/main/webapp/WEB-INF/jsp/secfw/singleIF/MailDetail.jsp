...
<title><spring:message code="secfw.page.title.bbsDetail" /></title>
...
<div class="pop_footer">
	<!-- Function Button -->
    <a href="javascript:pageAction('modify');" class="bt_all_b"><span><img src="<c:url value='/images/secfw/ico/ico_save.gif' />"><spring:message code="secfw.page.field.singleIF.save"/></span></a>
    <a href="javascript:pageAction('delete');" class="bt_all_w"><span><img src="<c:url value='/images/secfw/ico/ico_minus.gif' />"><spring:message code="secfw.page.field.singleIF.delete"/></span></a>
    <a href="javascript:pageAction('close');" class="bt_all_w"><span><img src="<c:url value='/images/secfw/ico/ico_cancel.gif' />"><spring:message code="secfw.page.field.singleIF.close"/></span></a>
	<!-- // Function Button -->
</div>
<!-- //Popup Footer -->
</form:form>
