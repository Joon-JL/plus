...
<link href="<c:url value='/style/secfw/calendar.css' />" rel="stylesheet" type="text/css">
...
function fPopCalendar(popCtrl, dateCtrl, popCal)
{
    ...
    {	
        // 4주
		if (ifrmHeight == 157) {
	    	top = point.y+popCtrl.offsetHeight-176;
		}
		// 5주
		...
		// 6주
			...
			top = point.y+popCtrl.offsetHeight-216;
		}
    }
}
...
//2011.09.09 신승완 추가
// @param  tmpX : 현재 마우스 좌표 X 값
// @param  tmpY : 현재 마우스 좌표 Y 값
function fPopCalendarDownMouse(popCtrl, dateCtrl, popCal, tmpX, tmpY)
{
    fResize();
...
function Header(Year, Month)
{
    ...
    var Header_String = Year + "<spring:message code='secfw.page.field.common.theYear'/>" + Month_Label[Month];
...
function On_Month()
{
    ...
    {
        alert("<spring:message code='secfw.page.field.common.inputCorrectYear'/>");
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><table width="0%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="10"><img src="<c:url value='/images/secfw/btn/bt_calendar_prev.gif' />"  width="5" height="9" onclick="Skip('-')" style="cursor:hand;"></td>
                            <td width="53"> 
                            ...
                            <td><img src="<c:url value='/images/secfw/btn/bt_calendar_next.gif' />"  width="5" height="9" onclick="Skip('+')" style="cursor:hand;"></td>
                          </tr>
                        </table></td>
