...
function pageAction(div){
	...
	if(div == "search"){		
		...
		frm.method.value = "listApntUserMng";
		frm.submit();
		frm.target = "_self";
		...
		frm.target		 = "_self";
		frm.action       = "<c:url value='/secfw/userMng.do' />";
		frm.method.value = "SaveApntUserMng";
		frm.submit();
		frm.target = "_self";
	}
}
...
<div id="wrap">
	<div id="container">
		...
		<!-- title -->
		<div class="title">
			<h3><spring:message code="secfw.page.field.user.authContMg"/></h3>
		</div>
		<!-- //title -->
				...
				<tr>
					<td>
						...
						<table class="search_form">
						   ...
						   <tr>
						    <th><spring:message code="secfw.page.field.user.authContV"/></th>
							<td>
	 ...
	 <!-- // search-->
		...
		<div class='tabletwo h_120'>
			...
			<tr>
				...
				<td  align="center" ><%=lom.get("auth_apnt_yn2")%></td>			
				...
				<input type="hidden" name="auth_apnt_yn_arr" id="auth_apnt_yn_arr" value="<%=lom.get("auth_apnt_yn2")%>">
	...
	<!-- 이성한 delete 버튼 삭제
			<span class="btn_all_w"><a href="javascript:pageAction('delete')"><span class="delete"></span><spring:message code="secfw.page.field.user.delete"/></a></span>
			-->
		</div>
