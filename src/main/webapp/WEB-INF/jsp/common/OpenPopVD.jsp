...
a {color:#03a3d7;  text-decoration: none;}
a:hover { color:#03a3d7; text-decoration: underline;} 

.bg {position: absolute;height:600px; width: 500px; background:url(<%=IMAGE%>/notice_bg2.jpg) no-repeat right top;}
.contents {position: relative; width:276px; height:280px; padding-top: 231px; padding-left: 224px; }
.btn {position: relative; width: 480px; padding-bottom: 30px; padding-right: 20px; text-align: right;}
.today {text-align: right; position: relative; width:480px; height:24px; padding-left: 10px; padding-top: 3px; font-family:'Malgun Gothic','맑은고딕','Dotum','돋움',Tahoma,sans-serif,arial,verdana; font-size:12px; color:#fff;}
...
<div class="bg">
<div class="contents">
	<a href="#">vdcontract@samsung.com</a>
</div>
         <div class="btn"><a href="http://legal2.sec.samsung.net/login.do?f=c" target="_blank"><img src="<%=IMAGE%>/btn_go.png" border="0"/></a></div>
         <div class="today">오늘 하루 열지 않기 
...
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title><spring:message code="common.page.field.OpenPopVD.noticeOutofOrder"/></title>
<style type="text/css">
body, div, h1, h2, h3, h4, h5, h6, ul, ol, li, dl, dt, dd, p, form, fieldset, input, table, tr, th, td, a 
{margin:0;padding:0; font-family:'Malgun Gothic','맑은고딕','Dotum','돋움',Tahoma,sans-serif,arial,verdana; font-size:12px; color:#1a1a1a; line-height:18px;}
...
function closeWin(){
	var frm = document.frm ;	
	if (frm.closeEvent.checked ) {
		setCookie("noticePopupClm", "no" , 1); // 1일 간 쿠키적용 	
	}
	self.close();	
}
</script>
...
<!-- 팝업창 사이즈 너비 350px * 390px  -->
	<div class="bg">
		...
		<div class='notice_mid'>
			...
			<img src="<%=IMAGE%>/notice_ball.png" border="0" align="absmiddle"/><spring:message code="common.page.field.OpenPopVD.inq4967"/><br/><br/>
			 
			<span class='green font-12'><spring:message code="common.page.field.OpenPopVD.byRenewal"/>
                   <spring:message code="common.page.field.OpenPopVD.contactLg"/>
           </span>  <br/> <br/>
	...
	<div class="today"><spring:message code="common.page.field.OpenPopVD.closeToday"/>
    	<input type="checkbox" name="closeEvent" id="closeEvent" onClick="javascript:closeWin();"/>
    </div>	
<!-- //팝업창 사이즈 너비 350px * 390px  -->	
</form>
