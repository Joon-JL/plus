...
<div id="wrap">
	...
	<form:form id="frm" name="frm" method="post" autocomplete="off">
		...
		<!-- Title -->
		<div class="title">
		<h3><a href="#"><spring:message code="clm.page.msg.common.contractTerm" /></a></h3>
		</div>
		...
		<td height="600px" >
			...
			<script>	
			  	...
			  	if(langCd.startsWith("ko")){
			  		rdOpen("<c:out value='${command.report_url}'/>"+"/report/contract_close.mrd", parm , "", 100);
			  	}
			  	else{
			  		rdOpen("<c:out value='${command.report_url}'/>"+"/report/en_contract_close.mrd", parm , "", 100);
			  	}
			</script>
		</td>
		</tr>	
