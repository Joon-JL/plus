...
<%--
/**
 * 파  일  명 : Template_i.jsp
 * 프로그램명 : 표준 Template 등록
 * 설      명 : 
 * 작  성  자 : 
 * 작  성  일 : 
 */
...
<script language="javascript">
	...
	$(document).ready(function(){
		...
		//언어
		getCodeSelectByUpCd("frm", "lang_gbn", '/common/clmsCom.do?method=listComCdByGrpCd&combo_sys_cd=CLM&combo_abbr=&combo_grp_cd=C045&combo_type=S&combo_del_yn=N&combo_selected=');
	...
	*/
	function pageAction(flag){
		...
		if(flag == "insert"){
		    ...
		    frm.method.value = "insertTemplate";
	...
	function returnCustomer(obj){
    	...
    	returnVal += "&nbsp;";
    	returnVal += "<a href='javascript:customerImgClick("+obj.index+");' ><img SRC='<%=IMAGE%>/icon/cancel_new.gif'/></a>";
    	returnVal += "<input type='hidden' id='cntrt_oppnt_cds"+obj.index+"' name='cntrt_oppnt_cds' value='" + obj.customer_cd + "' />";
    	returnVal += "<input type='hidden' id='cntrt_oppnt_nms"+obj.index+"' name='cntrt_oppnt_nms' value='" + obj.customer_nm1 + "' />";
    	returnVal += "</span>&nbsp;&nbsp;";
...
<div id="wrap">
	...
	<div id="container">	
		...
		<!-- title -->
		<div class="title">
			<h3><spring:message code="clm.page.title.template.insertTitle" /></h3>
		</div>
		<!-- //title -->
			...
			<table border="0" cellspacing="0" cellpadding="0" class="table-style01">
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="3">
							<input type="text" name="title" id="title" required alt="<spring:message code="clm.page.field.template.title" />" maxLength="300" class="text_full" style="width:600px" />
						</td>
					</tr>
					<tr>
