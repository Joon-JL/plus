	...
	*/
	function pageAction(flag){
		...
		if(flag == "modify"){
		    ...
		    frm.method.value = "forwardModifyItemLibrary";
			...
			if(confirm("<spring:message code='secfw.msg.ask.delete' />")){
				viewHiddenProgress(true) ;
			    frm.method.value = "deleteItemLibrary";
				frm.lib_no.value = <%=lom.get("lib_no")%>;
			    frm.submit();
			}	
		} else if(flag == "list"){	
...
<div id="wrap">
	...
	<div id="container">	
		...
		<!-- title -->
		<div class="title">
			<h3><spring:message code="clm.page.title.itemlibrary.detailTitle" /></h3>
		</div>
		<!-- //title -->
		...
		<div id="content">
			...
			<table border="0" cellspacing="0" cellpadding="0" class="table-style01">
				...
				<tbody>
					...
					<tr>
						<th><spring:message code="clm.page.field.itemlibrary.langGbn" /></th>
						<td colspan="3"><%=lom.get("lang_gbn_nm")%></td>
					</tr>
					<tr>
						<th><spring:message code="clm.page.field.itemlibrary.cont" /></th>
						<td colspan="3">
