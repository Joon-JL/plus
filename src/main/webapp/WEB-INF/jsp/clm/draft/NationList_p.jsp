...
<!--
	...
	function setCountry(){
		...
		for(var i=0; i < allCountry.length ; i++) {
			...
			opener.frm.nation2.value = allCountry.item(checkedNum).value;
			opener.frm.srch_nation.value = allCountry.item(checkedNum).title;		
			window.close();
	}
		...
		<div class="pop_content">
			...
			<!-- 
				 <div class="btn_wrap fR">
     				<span class="btn_all_b"><span class="save"></span><a href="#" onclick="javascript:setCountry();"><spring:message code="clm.page.msg.common.confirm" /></a></span>
