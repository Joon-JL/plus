...
<script language="javascript">
	...
	*/
	function pageAction(flag){
		...
		//저장
		if(flag == "insert"){
		    frm.method.value = "insertItemLibrary";
...
<div id="wrap">
	...
	<div id="container">	
		...
		<!-- title -->
		<div class="title">
			<h3><spring:message code="clm.page.title.itemlibrary.insertTitle" /></h3>
		</div>
		<!-- //title -->
			...
			<table border="0" cellspacing="0" cellpadding="0" class="table-style01">
				...
				<tbody>
					<tr>
						...
						<td colspan="3">
							<input type="text" name="title" id="title" required alt="<spring:message code="clm.page.field.itemlibrary.title" />" maxLength="300" class="text_full" style="width:600px" />
						</td>
					</tr>
					<tr>
