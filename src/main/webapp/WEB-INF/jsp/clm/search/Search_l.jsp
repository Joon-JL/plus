...
<%@ page import="com.sec.clm.search.dto.SearchForm"%>

<%-- 
/**
 * 파  일  명 : Search_l.jsp
 * 프로그램명 : 계약문서 검색화면(search)
 * 설      명 : 계약문서 검색화면 페이지(통합)
  */
--%>
...
<script language="javascript">
	...
	*/
	...
	/**
	* 검색결과 더보기 function(계약그룹, 공지 및 Q&A그룹)
	*/
...
<div id="wrap">
	...
	**************************** Form Setting **************************** 
	-->
		...
		<%
			SearchForm command = (SearchForm) request.getAttribute("command");
			String indexdb = command.getSrch_index_db();
			
			String resultListG_Count = "";
			String resultList0_Count = "";
			String resultList1_Count = "";
			String resultList2_Count = "";
			String resultList3_Count = "";
			String resultList4_Count = "";
			
			String resultListG2_Count = "";
			String resultList5_Count = "";
			String resultList6_Count = "";
			String resultList7_Count = "";
			
			String resultList8_Count = "";
			
			String resultList9_Count = "";
			
			String resultList10_Count = "";
			
			String resultListG3_Count = "";
			String resultList11_Count = "";
			String resultList12_Count = "";
			String resultList13_Count = "";
			
			if(indexdb.indexOf("clm_master_consideration,clm_master_consultation,clm_master_conclusion,clm_master_execution,clm_master_completion") != -1) {
				resultListG_Count = "(" + request.getAttribute("resultListG_Count") + ")";
				resultList0_Count = "(" + request.getAttribute("resultList0_Count") + ")";
				resultList1_Count = "(" + request.getAttribute("resultList1_Count") + ")";
				resultList2_Count = "(" + request.getAttribute("resultList2_Count") + ")";
				resultList3_Count = "(" + request.getAttribute("resultList3_Count") + ")";
				resultList4_Count = "(" + request.getAttribute("resultList4_Count") + ")";
			}
			if(indexdb.indexOf("clm_advice_review,clm_advice_request,clm_advice_ntts") != -1) {
				resultListG2_Count = "(" + request.getAttribute("resultListG2_Count") + ")";
				resultList5_Count = "(" + request.getAttribute("resultList5_Count") + ")";
				resultList6_Count = "(" + request.getAttribute("resultList6_Count") + ")";
				resultList7_Count = "(" + request.getAttribute("resultList7_Count") + ")";
			}
			if(indexdb.indexOf("clm_about") != -1) {
				resultList8_Count = "(" + request.getAttribute("resultList8_Count") + ")";
			}
			if(indexdb.indexOf("clm_rule_regulation") != -1) {
				resultList9_Count = "(" + request.getAttribute("resultList9_Count") + ")";
			}
			if(indexdb.indexOf("clm_share_terms") != -1) {
				resultList10_Count = "(" + request.getAttribute("resultList10_Count") + ")";
			}
			if(indexdb.indexOf("clm_counsel_notice,clm_counsel_faq,clm_counsel_qna") != -1) {
				resultListG3_Count = "(" + request.getAttribute("resultListG3_Count") + ")";
				resultList11_Count = "(" + request.getAttribute("resultList11_Count") + ")";
				resultList12_Count = "(" + request.getAttribute("resultList12_Count") + ")";
				resultList13_Count = "(" + request.getAttribute("resultList13_Count") + ")";
			}
		%>
		<!-- lnb -->
		<div id="lnbColum">
			...
			<div class="lnb_menu">
			<ul class="lnb_menu"><a href="javascript:goGroupMore('clm_master_consideration,clm_master_consultation,clm_master_conclusion,clm_master_execution,clm_master_completion');"><spring:message code="clm.page.field.srch.contract" /> <%=resultListG_Count %></a>
				<li><a href="javascript:goMore('clm_master_consideration');"><spring:message code="clm.page.field.srch.consideration" /> <%=resultList0_Count %></a></li>
				<li><a href="javascript:goMore('clm_master_consultation');"><spring:message code="clm.page.field.srch.consultation" /> <%=resultList1_Count %></a></li>
				<li><a href="javascript:goMore('clm_master_conclusion');"><spring:message code="clm.page.field.srch.conclusion" /> <%=resultList2_Count %></a></li>
				<li><a href="javascript:goMore('clm_master_execution');"><spring:message code="clm.page.field.srch.execution" /> <%=resultList3_Count %></a></li>
				<li><a href="javascript:goMore('clm_master_completion');"><spring:message code="clm.page.field.srch.completion" /> <%=resultList4_Count %></a></li>
			</ul>
			<ul class="lnb_menu"><a href="javascript:goGroupMore('clm_advice_review,clm_advice_request,clm_advice_ntts');"><spring:message code="clm.page.field.srch.advice" /> <%=resultListG2_Count %></a>
				<%
				...
				%>
				<li><a href="javascript:goMore('clm_advice_review');"><spring:message code="clm.page.field.srch.advicereview" /> <%=resultList5_Count %></a></li>
				<%
				    }
				%>
				<li><a href="javascript:goMore('clm_advice_request');"><spring:message code="clm.page.field.srch.advicerequest" /> <%=resultList6_Count %></a></li>
				<%
				    if (ClmsBoardUtil.searchRole(request, "RA00") || ClmsBoardUtil.searchRole(request, "RA01") || ClmsBoardUtil.searchRole(request, "RD01") || ClmsBoardUtil.searchRole(request, "RM00") || ClmsBoardUtil.searchRole(request, "RA02")) {
				%>
				<li><a href="javascript:goMore('clm_advice_ntts');"><spring:message code="clm.page.field.srch.advicentts" /> <%=resultList7_Count %></a></li>
				<%
				    }
				%>
			</ul>
			<ul class="lnb_menu"><a href="javascript:goMore('clm_about');"><spring:message code="clm.page.field.srch.about" />  <%=resultList8_Count %></a></li>
			<ul class="lnb_menu"><a href="javascript:goMore('clm_rule_regulation');"><spring:message code="clm.page.field.srch.rule" />  <%=resultList9_Count %></a></li>
			<ul class="lnb_menu"><a href="javascript:goMore('clm_share_terms');"><spring:message code="clm.page.field.srch.share" />  <%=resultList10_Count %></a></li>
			<ul class="lnb_menu"><a href="javascript:goGroupMore('clm_counsel_notice,clm_counsel_faq,clm_counsel_qna');"><spring:message code="clm.page.field.srch.counsel" />  <%=resultListG3_Count %></a></li>
				<li><a href="javascript:goMore('clm_counsel_notice');"><spring:message code="clm.page.field.srch.notice" />  <%=resultList11_Count %></a></li>
				<li><a href="javascript:goMore('clm_counsel_faq');"><spring:message code="clm.page.field.srch.faq" />  <%=resultList12_Count %></a></li>
				<li><a href="javascript:goMore('clm_counsel_qna');"><spring:message code="clm.page.field.srch.qna" />  <%=resultList13_Count %></a></li>
			</ul>
			</div>
		</div>
		<!-- //lnb -->
		...
		<div id="content_in">
			...
			<!-- 
				<c:if test="${langCd eq 'ko'}">
					<spring:message code="clm.page.field.srch.query" /> <span class="blue">&quot;<c:out value='${command.queryText}'/>&quot;</span><spring:message code="clm.page.msq.srch.searchResult1" /> <c:out value='${totalSearchCount}'/><spring:message code="clm.page.msq.srch.searchResult2" />
				</c:if>
				<c:if test="${langCd eq 'en'}">
					<c:out value='${totalSearchCount}'/> cases have been found as a result of the search word <span class="blue">&quot;<c:out value='${command.queryText}'/>&quot;</span>
				</c:if>
			 -->
			...
			<div class="t_titBtn">
				<div class="title_basic">
					<h4><spring:message code="clm.page.field.srch.contract" /> (<c:out value='${resultListG_Count}'/>)</h4>
				</div>			
			</div>
			<c:choose>
			<c:when test="${resultListG_Count > 0}">
			<dl class="search_view_list">
			<dt></dt>
			<!-- //sub title and more -->
			<c:choose>
				<c:when test="${resultList0_Count > 0}">					
					<div class="t_titBtn">
						<div class="title_basic3">
							<spring:message code="clm.page.field.srch.consideration" /> (<c:out value='${resultList0_Count}'/>)
						</div>
						<c:if test="${resultList0_Count > 3}">
							<div class="title_more">
								<span class="more_btn"><a href="javascript:goMore('clm_master_consideration');"><spring:message code="clm.page.field.srch.more" /></a></span>
							</div>
						</c:if>				
					</div>										
					<!-- search view -->
					<c:forEach var="list" items="${resultList0}" varStatus="status">
					<dt>
					...
					<dd class="date_name">
						(<spring:message code="clm.page.field.srch.createDate" /> : <c:out value='${list.dredate}'/> | <spring:message code="clm.page.field.srch.srchReqmanNm" /> : <c:out value='${list.if_writer}'/>)
					</dd>
					</c:forEach>
					<dt></dt>
					<!-- //search view -->
			...
			<c:choose>
				<c:when test="${resultList1_Count > 0}">
					<div class="t_titBtn">
						<div class="title_basic3">
							<spring:message code="clm.page.field.srch.consultation" /> (<c:out value='${resultList1_Count}'/>)
						</div>
						<c:if test="${resultList1_Count > 3}">
							<div class="title_more">
								<span class="more_btn"><a href="javascript:goMore('clm_master_consultation');"><spring:message code="clm.page.field.srch.more" /></a></span>
							</div>
						</c:if>				
					</div>					
					<!-- search view -->
			...
			<c:choose>
				<c:when test="${resultList2_Count > 0}">
					<div class="t_titBtn">
						<div class="title_basic3">
							<spring:message code="clm.page.field.srch.conclusion" /> (<c:out value='${resultList2_Count}'/>)
						</div>
						<c:if test="${resultList2_Count > 3}">
							<div class="title_more">
								<span class="more_btn"><a href="javascript:goMore('clm_master_conclusion');"><spring:message code="clm.page.field.srch.more" /></a></span>
							</div>
						</c:if>				
					</div>
					<!-- search view -->
			...
			<c:choose>
				<c:when test="${resultList3_Count > 0}">
					<div class="t_titBtn">
						<div class="title_basic3">
							<spring:message code="clm.page.field.srch.execution" /> (<c:out value='${resultList3_Count}'/>)
						</div>
						<c:if test="${resultList3_Count > 3}">
							<div class="title_more">
								<span class="more_btn"><a href="javascript:goMore('clm_master_execution');"><spring:message code="clm.page.field.srch.more" /></a></span>
							</div>
						</c:if>				
					</div>					
					<!-- search view -->
			...
			<c:choose>
				<c:when test="${resultList4_Count > 0}">
					<div class="t_titBtn">
						<div class="title_basic3">
							<spring:message code="clm.page.field.srch.completion" /> (<c:out value='${resultList4_Count}'/>)
						</div>
						<c:if test="${resultList4_Count > 3}">
							<div class="title_more">
								<span class="more_btn"><a href="javascript:goMore('clm_master_completion');"><spring:message code="clm.page.field.srch.more" /></a></span>
							</div>
						</c:if>				
					</div>					
					<!-- search view -->
			...
			<div class="t_titBtn">
				<div class="title_basic">
					<h4><spring:message code="clm.page.field.srch.advice" /> (<c:out value='${resultListG2_Count}'/>)</h4>
				</div>			
			</div>
			<c:choose>
			<c:when test="${resultListG2_Count > 0}">
			<dl class="search_view_list">
			<dt></dt>
			<!-- //sub title and more -->
			...
			<!-- Legal Advice Review-->
			<c:choose>
				<c:when test="${resultList5_Count > 0}">					
					<div class="t_titBtn">
						<div class="title_basic3">
							<spring:message code="clm.page.field.srch.advicereview" /> (<c:out value='${resultList5_Count}'/>)
						</div>
						<c:if test="${resultList5_Count > 3}">
							<div class="title_more">
								<span class="more_btn"><a href="javascript:goMore('clm_advice_review');"><spring:message code="clm.page.field.srch.more" /></a></span>
							</div>
						</c:if>				
					</div>										
					<!-- search view -->
			...
			<c:choose>
				<c:when test="${resultList6_Count > 0}">
					<div class="t_titBtn">
						<div class="title_basic3">
							<spring:message code="clm.page.field.srch.advicerequest" /> (<c:out value='${resultList6_Count}'/>)
						</div>
						<c:if test="${resultList6_Count > 3}">
							<div class="title_more">
								<span class="more_btn"><a href="javascript:goMore('clm_advice_request');"><spring:message code="clm.page.field.srch.more" /></a></span>
							</div>
						</c:if>				
					</div>					
					<!-- search view -->
					<c:forEach var="list" items="${resultList6}" varStatus="status">
					<dt>
					<a href="javascript:Menu.detail2('frm', 'frTop', '<c:out value='${list.lf_up_menu_id}' escapeXml="false" />', '<c:out value='${list.lf_menu_id}' escapeXml="false" />' ,  '<c:out value='${list.link_url}' escapeXml="false" />');"><c:out value='${list.dretitle}' escapeXml="false" /></a>
					</dt>
					<dd class="view_text">
			...
			<%
			    if (ClmsBoardUtil.searchRole(request, "RA00") || ClmsBoardUtil.searchRole(request, "RA01") || ClmsBoardUtil.searchRole(request, "RD01") || ClmsBoardUtil.searchRole(request, "RM00") || ClmsBoardUtil.searchRole(request, "RA02")) {
			%>
			<!-- Legal Advice (not through the system) -->
			<c:choose>
				<c:when test="${resultList7_Count > 0}">
					<div class="t_titBtn">
						<div class="title_basic3">
							<spring:message code="clm.page.field.srch.advicentts" /> (<c:out value='${resultList7_Count}'/>)
						</div>
						<c:if test="${resultList7_Count > 3}">
							<div class="title_more">
								<span class="more_btn"><a href="javascript:goMore('clm_advice_ntts');"><spring:message code="clm.page.field.srch.more" /></a></span>
							</div>
						</c:if>				
					</div>
					<!-- search view -->
					<c:forEach var="list" items="${resultList7}" varStatus="status">
					<dt>
					<a href="javascript:Menu.detail2('frm', 'frTop', '<c:out value='${list.lf_up_menu_id}' escapeXml="false" />', '<c:out value='${list.lf_menu_id}' escapeXml="false" />',  '<c:out value='${list.link_url}' escapeXml="false" />');"><c:out value='${list.dretitle}' escapeXml="false" /></a>
					</dt>
					<dd class="view_text">
			...
			<div class="t_titBtn">
				<div class="title_basic">
					<h4><spring:message code="clm.page.field.srch.about" /> (<c:out value='${resultList8_Count}'/>)</h4>
				</div>
				<c:if test="${resultList8_Count > 3}">
					<div class="title_more">
						<span class="more_btn"><a href="javascript:goMore('clm_about');"><spring:message code="clm.page.field.srch.more" /></a></span>
					</div>
				</c:if>				
			</div>
			<!-- //sub title and more -->
			<c:choose>
				<c:when test="${resultList8_Count > 0}">
					<!-- search view -->
					<dl class="search_view_list">
					<c:forEach var="list" items="${resultList8}" varStatus="status">
					<dt><a href="javascript:Menu.detail2('frm', 'frTop', '<c:out value='${list.lf_up_menu_id}' escapeXml="false" />', '<c:out value='${list.lf_menu_id}' escapeXml="false" />',  '<c:out value='${list.link_url}' escapeXml="false" />');"><c:out value='${list.dretitle}' escapeXml="false" /></a></dt>
					<dd class="view_text">
					<c:out value='${list.drecontent}' escapeXml="false" />
					</dd>
					<dd class="date_name">
						(<spring:message code="clm.page.field.srch.createDate" /> : <c:out value='${list.dredate}'/>)
					</dd>
					</c:forEach>
					</dl>
					<!-- //search view -->
			...
			<div class="t_titBtn">
				<div class="title_basic">
					<h4><spring:message code="clm.page.field.srch.library" /> (<c:out value='${resultList8_Count}'/>)</h4>
				</div>
				<c:if test="${resultList8_Count > 3}">
					<div class="title_more">
						<span class="more_btn"><a href="javascript:goMore('clm_library');"><spring:message code="clm.page.field.srch.more" /></a></span>
					</div>
				</c:if>				
			</div>
			<!-- //sub title and more --> --%>
			<%-- <c:choose>
				<c:when test="${resultList8_Count > 0}">
					...
					<dd class="date_name">
						(<spring:message code="clm.page.field.srch.createDate" /> : <c:out value='${list.dredate}'/> | <spring:message code="clm.page.field.srch.writer" /> : <c:out value='${list.if_writer}'/>)
					</dd>
					</c:forEach>
					</dl>
					<!-- //search view -->
			...
			<div class="t_titBtn">
				<div class="title_basic">
					<h4><spring:message code="clm.page.field.srch.rule" /> (<c:out value='${resultList9_Count}'/>)</h4>
				</div>
				<c:if test="${resultList9_Count > 3}">
					<div class="title_more">
						<span class="more_btn"><a href="javascript:goMore('clm_rule_regulation');"><spring:message code="clm.page.field.srch.more" /></a></span>
					</div>
				</c:if>				
			</div>
			<!-- //sub title and more -->
			<c:choose>
				<c:when test="${resultList9_Count > 0}">
					<!-- search view -->
					<dl class="search_view_list">
					<c:forEach var="list" items="${resultList9}" varStatus="status">
					<dt><a href="javascript:Menu.detail2('frm', 'frTop', '<c:out value='${list.lf_up_menu_id}' escapeXml="false" />', '<c:out value='${list.lf_menu_id}' escapeXml="false" />',  '<c:out value='${list.link_url}' escapeXml="false" />');"><c:out value='${list.dretitle}' escapeXml="false" /></a></dt>
					<dd class="view_text">
					<c:out value='${list.drecontent}' escapeXml="false" />
					</dd>
			...
			<div class="t_titBtn">
				<div class="title_basic">
					<h4><spring:message code="clm.page.field.srch.share" /> (<c:out value='${resultList10_Count}'/>)</h4>
				</div>
				<c:if test="${resultList10_Count > 3}">
					<div class="title_more">
						<span class="more_btn"><a href="javascript:goMore('clm_share_terms');"><spring:message code="clm.page.field.srch.more" /></a></span>
					</div>
				</c:if>				
			</div>
			<!-- //sub title and more -->
			<c:choose>
				<c:when test="${resultList10_Count > 0}">
					<!-- search view -->
					<dl class="search_view_list">
					<c:forEach var="list" items="${resultList10}" varStatus="status">
					<dt><a href="javascript:Menu.detail2('frm', 'frTop', '<c:out value='${list.lf_up_menu_id}' escapeXml="false" />', '<c:out value='${list.lf_menu_id}' escapeXml="false" />',  '<c:out value='${list.link_url}' escapeXml="false" />');"><c:out value='${list.dretitle}' escapeXml="false" /></a></dt>
					<dd class="view_text">
					<c:out value='${list.drecontent}' escapeXml="false" />
					</dd>
			...
			<div class="t_titBtn">
				<div class="title_basic">
					<h4><spring:message code="clm.page.field.srch.counsel" /> (<c:out value='${resultListG3_Count}'/>)</h4>
				</div>				
			</div>
			<!-- //sub title and more -->
			<c:choose>
			<c:when test="${resultListG3_Count > 0}">
			<dl class="search_view_list">
			<!-- //sub title and more -->
			<c:choose>
				<c:when test="${resultList11_Count > 0}">
					<div class="t_titBtn">
						<div class="title_basic3">
							<spring:message code="clm.page.field.srch.notice" /> (<c:out value='${resultList11_Count}'/>)
						</div>
						<c:if test="${resultList11_Count > 3}">
							<div class="title_more">
								<span class="more_btn"><a href="javascript:goMore('clm_counsel_notice');"><spring:message code="clm.page.field.srch.more" /></a></span>
							</div>
						</c:if>				
					</div>					
					<!-- search view -->
					<c:forEach var="list" items="${resultList11}" varStatus="status">
					<dt>
					<a href="javascript:Menu.detail2('frm', 'frTop', '<c:out value='${list.lf_up_menu_id}' escapeXml="false" />', '<c:out value='${list.lf_menu_id}' escapeXml="false" />',  '<c:out value='${list.link_url}' escapeXml="false" />');"><c:out value='${list.dretitle}' escapeXml="false" /></a>
					</dt>
					<dd class="view_text">
			...
			<c:choose>
				<c:when test="${resultList12_Count > 0}">
					<div class="t_titBtn">
						<div class="title_basic3">
							<spring:message code="clm.page.field.srch.faq" /> (<c:out value='${resultList12_Count}'/>)
						</div>
						<c:if test="${resultList12_Count > 3}">
							<div class="title_more">
								<span class="more_btn"><a href="javascript:goMore('clm_counsel_faq');"><spring:message code="clm.page.field.srch.more" /></a></span>
							</div>
						</c:if>				
					</div>				
					<!-- search view -->
					<c:forEach var="list" items="${resultList12}" varStatus="status">
					<dt>
					<a href="javascript:Menu.detail2('frm', 'frTop', '<c:out value='${list.lf_up_menu_id}' escapeXml="false" />', '<c:out value='${list.lf_menu_id}' escapeXml="false" />' ,  '<c:out value='${list.link_url}' escapeXml="false" />');"><c:out value='${list.dretitle}' escapeXml="false" /></a>
					</dt>
					<dd class="view_text">
			...
			<c:choose>
				<c:when test="${resultList13_Count > 0}">
					<div class="t_titBtn">
						<div class="title_basic3">
							<spring:message code="clm.page.field.srch.qna" /> (<c:out value='${resultList13_Count}'/>)
						</div>
						<c:if test="${resultList13_Count > 3}">
							<div class="title_more">
								<span class="more_btn"><a href="javascript:goMore('clm_counsel_qna');"><spring:message code="clm.page.field.srch.more" /></a></span>
							</div>
						</c:if>				
					</div>					
					<!-- search view -->
					<c:forEach var="list" items="${resultList13}" varStatus="status">
					<dt>
					<a href="javascript:Menu.detail2('frm', 'frTop', '<c:out value='${list.lf_up_menu_id}' escapeXml="false" />', '<c:out value='${list.lf_menu_id}' escapeXml="false" />',  '<c:out value='${list.link_url}' escapeXml="false" />');"><c:out value='${list.dretitle}' escapeXml="false" /></a>
					</dt>
					<dd class="view_text">
