...
<script language="javascript">
	...
	$(document).ready(function(){
		initPage();
		//alert(document.frm.seqno.value + ','+ document.frm.up_seqno.value);
	});
...
<div id="wrap">
	...
	<div id="container">	
		...
		<!-- title -->
		<div class="title">
	        <h3><spring:message code="clm.page.title.qna.insertTitle" /></h3>
		</div>
		<!-- //title -->
		...
		<div id="content">
			...
			<table border="0" cellspacing="0" cellpadding="0" class="table-style01">
				...
				<tbody>
					<tr>
						<th><spring:message code="clm.page.field.qna.title" /><span class="astro">*</span></th>
						<td colspan="3">
							<input type="text" name="title" id="title" value="<c:out value='${command.title}'/>" required alt="<spring:message code="clm.page.field.qna.title" />" maxLength="256" class="text_full" style="width:600px" />
						</td>
					</tr>
					<tr>
