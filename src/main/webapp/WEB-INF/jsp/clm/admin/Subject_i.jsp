	...
	function save() {
		...
		if(frm.cd_nm_eng.value==""){
		    ...
		    if(confirm("<spring:message code='secfw.msg.ask.insert' />")){
				frm.method.value = "insertSubject";
				frm.action = "<c:url value='/clm/admin/subject.do' />";
				frm.target = "_self";
				viewHiddenProgress(true);
				frm.submit();
...
<!-- 						</th> -->
<!-- 						<td colspan="3"> -->
<%-- 					  		<input type="text" name="cd_nm" id="cd_nm" class="text" size="100" value="" alt="<spring:message code='clm.page.field.admin.subject.cd_nm' />" maxLength="100" required /> --%>
<!-- 						</td> -->
<!-- 					</tr> -->
<!-- 					<tr> -->
<!-- 						<th> -->
...
<!-- 						</th> -->
<!-- 						<td colspan="3"> -->
<%-- 					  		<input type="text" name="cd_nm_abbr" id="cd_nm_abbr" class="text" size="100" value="" alt="<spring:message code='clm.page.field.admin.subject.cd_nm_abbr' />" maxLength="50" /> --%>
<!-- 						</td> -->
<!-- 					</tr> -->
					<tr>
						<th>
						...
						<td colspan="3">
					  		<input type="text" name="cd_nm_eng" id="cd_nm_eng" class="text_full" value="" alt="<spring:message code='clm.page.field.admin.subject.cd_nm' />" maxLength="100" />
						</td>
					</tr>
					<tr>
						<th>
						...
						<td colspan="3">
					  		<input type="text" name="cd_nm_abbr_eng" id="cd_nm_abbr_eng" class="text_full" value="" alt="<spring:message code='clm.page.field.admin.subject.cd_nm_abbr' />" maxLength="50" />
						</td>
					</tr>
					<tr class="end">
						<th>
