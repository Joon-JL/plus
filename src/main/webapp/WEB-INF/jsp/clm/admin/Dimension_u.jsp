	...
	function save() {
		...
		if(frm.cd_nm_eng.value==""){
		    ...
		    if(confirm("<spring:message code='secfw.msg.ask.update' />")){
		    	frm.method.value = "modifyDimension";
				frm.action = "<c:url value='/clm/admin/dimension.do' />";
				frm.target = "_self";
				viewHiddenProgress(true);
				frm.submit();
...
<!-- 						</th> -->
<!-- 						<td colspan="3"> -->
<%-- 					  		<span><input type="text" name="cd_nm" id="cd_nm" class="text" size="100" value="<c:out value='${lom.cd_nm}' default="" />" alt="<spring:message code='las.page.field.admin.dimension.cd_nm' />" maxLength="100" required /></span> --%>
<!-- 						</td> -->
<!-- 					</tr> -->
<!-- 					<tr> -->
<!-- 						<th> -->
...
<!-- 					</tr> -->
					<tr>
						...
						<td colspan="3">
					  		<input type="text" name="cd_nm_eng" id="cd_nm_eng" class="text_full" value="<c:out value='${lom.cd_nm_eng}' default="" />" alt="<spring:message code='las.page.field.admin.dimension.cd_nm' />" maxLength="100" />
						</td>
					</tr>
					<tr>
						<th>
						...
						<td colspan="3">
					  		<input type="text" name="cd_nm_abbr_eng" id="cd_nm_abbr_eng" class="text_full" value="<c:out value='${lom.cd_nm_abbr_eng}' default="" />" alt="<spring:message code='clm.page.field.admin.type.cd_nm_abbr' />" maxLength="50" />
						</td>
					</tr>
					<tr>
						<th>
