...
$(document).ready(function(){
	...
	function save() {
		...
		if(frm.cd_nm_eng.value==""){
		    ...
		    if(confirm("<spring:message code='secfw.msg.ask.update' />") && validateForm(frm)){
		    	frm.method.value = "modifyType";
				frm.action = "<c:url value='/clm/admin/type.do' />";
				frm.target = "_self";
				viewHiddenProgress(true);
				frm.submit();
...
<!-- 						</th> -->
<!-- 						<td colspan="3"> -->
<%-- 							<input type="text" name="cd_nm" id="cd_nm" class="text" size="100" value="<c:out value='${lom.cd_nm}' default="" />" alt="<spring:message code='clm.page.field.admin.type.cd_nm' />" maxLength="100" required /> --%>
<!-- 						</td> -->
<!-- 					</tr> -->
<!-- 					<tr> -->
<!-- 						<th> -->
...
<!-- 						</th> -->
<!-- 						<td colspan="3"> -->
<%-- 							<input type="text" name="cd_nm_abbr" id="cd_nm_abbr" class="text" size="100" value="<c:out value='${lom.cd_nm_abbr}' default="" />" alt="<spring:message code='clm.page.field.admin.type.cd_nm_abbr' />" maxLength="50" /> --%>
<!-- 						</td> -->
<!-- 					</tr> -->
					<tr>
						<th>
						...
						<td colspan="3">
							<input type="text" name="cd_nm_eng" id="cd_nm_eng" class="text" size="100" value="<c:out value='${lom.cd_nm_eng}' default="" />" alt="<spring:message code='clm.page.field.admin.type.cd_nm_eng' />" maxLength="100" />
						</td>
					</tr>
					<tr>
						<th>
						...
						<td colspan="3">
							<input type="text" name="cd_nm_abbr_eng" id="cd_nm_abbr_eng" class="text" size="100" value="<c:out value='${lom.cd_nm_abbr_eng}' default="" />" alt="<spring:message code='clm.page.field.admin.type.cd_nm_abbr_eng' />" maxLength="50" />
						</td>
					</tr>
					<tr>
						<th>
						...
						<td colspan="3">
							...
							<textarea name="cd_expl" id="cd_expl" rows="10" cols="98" maxLength="1000" onkeyup="frmChkLenMe(this,1000,'curByteExpl')"><c:out value='${lom.cd_expl}' default="" /></textarea>
						</td>
					</tr>
					<tr class="end">
						<th>
							...
							<dd style="float:left;">
								<span id="typeItem" >
									<c:forEach var="list" items="${lom_item}">
										<input type="hidden" id="item_cds" name="item_cds" value="<c:out value='${list.item_cd}'/>" />
										<input type="hidden" id="item_cd_nms" name="item_cd_nms" value="<c:out value='${list.item_cd_nm}'/>" />
										<input type="hidden" id="item_cd_nm_abbrs" name="item_cd_nm_abbrs" value="<c:out value='${list.item_cd_nm_abbr}'/>" />
										<input type="hidden" id="item_cd_nm_engs" name="item_cd_nm_engs" value="<c:out value='${list.item_cd_nm_eng}'/>" />
										<input type="hidden" id="item_cd_nm_abbr_engs" name="item_cd_nm_abbr_engs" value="<c:out value='${list.item_cd_nm_abbr_eng}'/>" />
