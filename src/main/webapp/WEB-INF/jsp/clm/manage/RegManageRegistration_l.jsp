...
<%-- 
/**
 * 파  일  명 : RegManageRegistration_l.jsp
 * 프로그램명 : 체결 후 등록 리스트 화면
 * 설      명 : 
 * 작  성  자 : 김재원
 * 작  성  일 : 2012.01.28
 */
		...
		<div id="content">
						...
						<tr>
							...
							<!-- 계약 기준 조회일 경우 -->
								<table class="search_form">
									...
									<tr>
										<th><spring:message code="clm.page.field.manageCommon.srchStep" /><!--<spring:message code="clm.page.field.manageCommon.srchOppntCd" />--></th>
										<td>
										...
										</td><th><spring:message code="clm.page.field.manageCommon.srchStatus" /></th>
										<td>
			...
			<div class="t_titBtn">
				<div class="btn_wrap_t">
					<span class="btn_all_w"><span class="reply"></span><a href="javascript:goInsertForm();"><spring:message code="clm.page.msg.manage.aftConclWrite" /></a></span>
				</div>
		  	</div>
		  	<!-- //button -->
		...
		<%if("cnsdreq".equals(command.getList_mode())){%>
			<table border="0" cellspacing="0" cellpadding="0" class="list_basic">
				<colgroup>
			  	...
			  	<thead>
					<tr>
						<th><nobr><spring:message code="clm.page.field.manageCommon.reqTitle" />2</nobr></th>
		...
		<%}else{%>
			<table border="0" cellspacing="0" cellpadding="0" class="list_basic">
				<colgroup>
			  	...
			  	<thead>
					<tr>
						<th><nobr><spring:message code="clm.page.msg.manage.reqName" /></nobr></th>
