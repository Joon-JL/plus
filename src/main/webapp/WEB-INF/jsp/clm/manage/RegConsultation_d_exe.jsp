...
<c:if test="${payment_gbn=='C02001' or payment_gbn=='C02002'}">
 --%>
							...
							<c:choose>
								<c:when test="${command.session_user_id == command.reqman_id}">
									<tr onMouseOut="this.className='';" onMouseOver="this.className='selected'">
									    ...
									    <td><input type="text" name="exec_amt_arr" id="exec_amt_arr" class="text_full" value="<c:out value='${list.exec_amt}'/>" size="10" maxLength="15" alt="<spring:message code="clm.page.msg.manage.amount" htmlEscape="true" />" num required/></td>
								...
								<c:otherwise>
									<tr onMouseOut="this.className='';" onMouseOver="this.className='selected'">
									    ...
									    <td class="tL"  title="<c:out value='${list.exec_itm}'/>"><nobr><c:out value='${list.exec_itm}'/></nobr></td>
									    <td><c:out value='${list.exec_plndday}'/></td>
									    <td><c:out value='${list.exec_amt}'/></td>
									    <td title="<c:out value='${list.exec_cont}'/>"><nobr><c:out value='${list.exec_cont}'/></nobr></td>
    ...
    <c:otherwise>
		<tr id="notFoundList123" onMouseOut="this.className='';" onMouseOver="this.className='selected'">
			<td colspan="6" align="center" class="tC">123<spring:message code="clm.msg.succ.noResult" /></td>
		</tr>
    </c:otherwise>
	</c:choose>
			</tbody>
