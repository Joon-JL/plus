...
<div id="contract-btn-content">
      <c:if test="${contractExecCommand.session_user_id==contractMstLom.reqman_id}" >
				<span class="btn_all_w"><span class="list"></span><a href="javascript:forwardConsideration()"><spring:message code="clm.page.msg.common.modify" /></a></span>&nbsp;
	  </c:if>
