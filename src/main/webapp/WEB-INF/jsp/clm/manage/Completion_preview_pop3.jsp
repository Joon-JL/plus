...
<!-- header -->
<h1><spring:message code="clm.page.msg.manage.doPrint" /><span class="close" onclick="javascript:self.close();" title="close"></span></h1>
<!-- //header -->
<!-- body -->
    <div class="pop_area">
        <div class="pop_content">
			...
			<input type="hidden" name="menu_id" id="menu_id" value="<c:out value='${command.menu_id}'/>" />			
       			...
       			<input type="hidden" name="content" id="content" value="<c:out value='${content}' />" />		
				...
				function OnInitCompleted(e){
					CrossEditor.SetValue(document.frm.content.value);
				}
