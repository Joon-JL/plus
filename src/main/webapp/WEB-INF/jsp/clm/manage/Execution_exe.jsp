...
<div class="tab_box">
	...
	<!-- button -->
		...
		<!--// 지불계획 -->
		<div id="rowAddDel" class="btnwrap">
			<!-- <span class="btn"><span class="add"></span><a href="javascript:insertExecution();"> 전체저장</a></span> -->
			<span class="btn_all_b"><span class="add"></span><a href="javascript:newExecution();"> <spring:message code="clm.page.msg.manage.addRow" /></a></span>
			<span class="btn_all_b"><span class="delete"></span><a href="javascript:deleteExecution();"> <spring:message code="clm.page.msg.manage.delRow" /></a></span>
		</div>
		<!--// 수금계획 -->
		<div id="rowAddDel2" class="btnwrap">
			<!-- <span class="btn"><span class="add"></span><a href="javascript:insertExecution();"> 전체저장</a></span> -->
			<span class="btn_all_b"><span class="add"></span><a href="javascript:newExecution2();"> <spring:message code="clm.page.msg.manage.addRow" /></a></span>
			<span class="btn_all_b"><span class="delete"></span><a href="javascript:deleteExecution();"> <spring:message code="clm.page.msg.manage.delRow" /></a></span>
		</div>
		<!--// 기타 이행계획 -->
		<div id="rowAddDel3" class="btnwrap">
			<!-- <span class="btn"><span class="add"></span><a href="javascript:insertExecution();"> 전체저장</a></span> -->
			<span class="btn_all_b"><span class="add"></span><a href="javascript:newExecution3();"> <spring:message code="clm.page.msg.manage.addRow" /></a></span>
			<span class="btn_all_b"><span class="delete"></span><a href="javascript:deleteExecution();"> <spring:message code="clm.page.msg.manage.delRow" /></a></span>
		</div>
	<!-- //button -->
</div>
		...
		<c:choose>
			<c:when test="${list.exec_status=='C03100'}">
					...
					<tr onmouseout="this.className='';" onmouseover="this.className='selected'" id="tr_<c:out value='${list.exec_seqno}'/>">
					 ...
					 <td class="tL"><c:out value='${list.exec_itm}' escapeXml="false"/>
					 <input type='hidden' name='exec_itm_arr' id='exec_itm_arr' class='text_90' value="<c:out value='${list.exec_itm}'/>" size='20' maxlength='60' alt="<spring:message code="clm.page.msg.manage.exeItm" htmlEscape="true" />" required readonly/></td>
			         <td class="tC"><input type='text' name='exec_plndday_arr' id="exec_plndday_arr1<c:out value='${list.exec_seqno}'/>" class='text_calendar' readonly='readonly' value="<c:out value='${list.exec_plndday}'/>" size='10' alt="<spring:message code="clm.page.msg.manage.compResDate" htmlEscape="true" />" required /></td>
			         <td class="tR"><input type='text' name='exec_amt_arr' id='exec_amt_arr' class='text_90' value="<c:out value='${list.exec_amt2}'/>" size='10' maxLength='18' alt="<spring:message code="clm.page.msg.manage.amount" htmlEscape="true" />" onkeyup='olnyNum(this)' style="IME-MODE: disabled;" required /></td>
			         <td class="tL"><input type='text' name='exec_cont_arr' id='exec_cont_arr' class='text_90' value="<c:out value='${list.exec_cont}' escapeXml="false"/>" size='20' maxLength='60' alt="<spring:message code="clm.page.msg.manage.sendCond" htmlEscape="true" />" required /></td>
			         <td class="tC"><input type='text' name='exec_cmpltday_arr' id="exec_cmpltday_arr1<c:out value='${list.exec_seqno}'/>" class="text_calendar<c:out value='${list.rno}'/>" readonly='readonly' value="<c:out value='${list.exec_cmpltday}'/>" size='10' alt="<spring:message code="clm.page.msg.manage.compDate" htmlEscape="true" />" /></td>
			         <td class="tC"><input type='text' name='note_arr' id='note_arr<c:out value='${list.exec_seqno}'/>' class='text_90' value="<c:out value='${list.note}' escapeXml="false"/>" size='20' maxlength='300' alt="<spring:message code="clm.page.msg.common.note" htmlEscape="true" />" /></td>
			         <td class="tC"><span class="btn_all_b"><span class="save"></span><a href='javascript:modifyExecution(
			...
			<tr onmouseout="this.className='';" onmouseover="this.className='selected'" id="tr_<c:out value='${list.exec_seqno}'/>">
			    ...
			    <td class="tL"  title="<c:out value='${list.exec_itm}'/>"><nobr><c:out value='${list.exec_itm}' escapeXml="false"/></nobr>
			    <input type="hidden" name="exec_itm_arr" id="exec_itm_arr" value="<c:out value='${list.exec_itm}'/>"/></td>
			    <td class="tC"><c:out value='${list.exec_plndday}'/>
			    <input type="hidden" name="exec_plndday_arr" id="exec_plndday_arr<c:out value='${list.rno}'/>" class="text_calendar" readonly="readonly" value="<c:out value='${list.exec_plndday}'/>" size="10" alt="<spring:message code="clm.page.msg.manage.compResDate" htmlEscape="true" />" required /></td>
			    <td class="tR"><fmt:formatNumber value='${list.exec_amt2}' pattern="#,#00.00#"/>
			    <input type="hidden" name="exec_amt_arr" id="exec_amt_arr" class="text_90" value="<c:out value='${list.exec_amt2}'/>" size="10" maxlength="15" alt="<spring:message code="clm.page.msg.manage.amount" htmlEscape="true" />" num /></td>
			    <td class="tL"><c:out value='${list.exec_cont}' escapeXml="false"/>
			    <input type="hidden" name="exec_cont_arr" id="exec_cont_arr" class="text_90" value="<c:out value='${list.exec_cont}'/>" size="20" maxlength="200" alt="<spring:message code="clm.page.msg.manage.sendCond" htmlEscape="true" />" /></td>
			    <td class="tC"><input type="text" name="exec_cmpltday_arr" id="exec_cmpltday_arr1<c:out value='${list.rno}'/>" class="text_calendar" readonly="readonly" value="<c:out value='${list.exec_cmpltday}'/>" size="10" alt="<spring:message code="clm.page.msg.manage.compDate" htmlEscape="true" />" /></td>
			    <td class="tL"><input type="text" name="note_arr" id="note_arr<c:out value='${list.exec_seqno}'/>" class="text_90" value="<c:out value='${list.note}' escapeXml="false"/>" size="20" maxlength="300" alt="<spring:message code="clm.page.msg.common.note" htmlEscape="true" />" /></td>
			    <td class="tC">
			    <span class="btn_all_b" id="btn_com"><span class="save"></span>
			    ...
			    <span class="btn_all_b" id="btn_rev"><span class="refresh"></span>
			...
			<tr onmouseout="this.className='';" onmouseover="this.className='selected'" >
			   <!-- <td id='exec_rn'><c:out value='${list.rno}'/></td> //-->
			    ...
			    <td class="tC txtover"><c:out value='${list.note}' escapeXml="false"/></td>
			    <td class="tC">
				    <c:choose>
...
<!-- //수금계획 -->
	...
	<c:when test="${pageUtil.totalRow > 0}">
		...
		<c:choose>
					...
					<tr onmouseout="this.className='';" onmouseover="this.className='selected'" id="tr_<c:out value='${list.exec_seqno}'/>">
					 <!-- <td id='exec_rn'><c:out value='${list.rno}'/></td> //-->
					 <td class='tL'><input type='text' name='exec_itm_arr' id='exec_itm_arr' class='text_90' value="<c:out value='${list.exec_itm}' escapeXml="false"/>" size='20' maxlength='60' alt="<spring:message code="clm.page.msg.manage.exeItm" htmlEscape="true" />" required readonly/></td>
			         <td class='tC'><input type='text' name='exec_plndday_arr' id="exec_plndday_arr2<c:out value='${list.rno}'/>" class='text_calendar' readonly='readonly' value="<c:out value='${list.exec_plndday}'/>" size='10' alt="<spring:message code="clm.page.msg.manage.compResDate" htmlEscape="true" />" required /></td>
			         <td class='tC'><input type='text' name='exec_amt_arr' id='exec_amt_arr' class='text_90 tR' value="<c:out value='${list.exec_amt2}'/>" size='10' maxlength='18' alt="<spring:message code="clm.page.msg.manage.amount" htmlEscape="true" />" onkeyup='olnyNum(this)' style="IME-MODE: disabled;" required /></td>
			         <td class='tL'><input type='text' name='exec_cont_arr' id='exec_cont_arr' class='text_90' value="<c:out value='${list.exec_cont}' escapeXml="false"/>" size='20' maxlength='60' alt="<spring:message code="clm.page.msg.manage.receiveCond" htmlEscape="true" />" required /></td>
			         <td class='tC'><input type='text' name='exec_cmpltday_arr' id="exec_cmpltday_arr2<c:out value='${list.exec_seqno}'/>" class="text_calendar<c:out value='${list.rno}'/>" readonly='readonly' value="<c:out value='${list.exec_cmpltday}'/>" size='10' alt="<spring:message code="clm.page.msg.manage.compDate" htmlEscape="true" />" /></td>
			         <td class='tL'><input type='text' name='note_arr' id='note_arr<c:out value='${list.exec_seqno}'/>' class='text_90' value="<c:out value='${list.note}' escapeXml="false"/>" size='20' maxlength='300' alt="<spring:message code="clm.page.msg.common.note" htmlEscape="true" />"/></td>
 					 <td class='tC'><span class="btn_all_b"><span class="save"></span>
			         <a href='javascript:modifyExecution(
			         "<c:out value='${list.cntrt_id}'/>"
			    	,"<c:out value='${list.exec_seqno}'/>"
			    	,"<c:out value='${list.exec_status}'/>"
			...
			<tr onmouseout="this.className='';" onmouseover="this.className='selected'" id="tr_<c:out value='${list.exec_seqno}'/>">
			   <!-- <td id='exec_rn'><c:out value='${list.rno}'/></td> //-->
			    <td class="tL txtover"  title="<c:out value='${list.exec_itm}'/>"><nobr><c:out value='${list.exec_itm}' escapeXml="false"/></nobr>
			    <input type="hidden" name="exec_itm_arr" id="exec_itm_arr" value="<c:out value='${list.exec_itm}'/>"/></td>
			    <td class='tC'><c:out value='${list.exec_plndday}'/>
			    <input type="hidden" name="exec_plndday_arr" id="exec_plndday_arr2<c:out value='${list.rno}'/>" class="text_calendar" readonly="readonly" value="<c:out value='${list.exec_plndday}'/>" size="10" alt="<spring:message code="clm.page.msg.manage.compResDate" htmlEscape="true" />" required /></td>
			    <td class='tR'><input type="text" name="exec_amt_arr" id="exec_amt_arr" class="text_90 tR" value="<c:out value='${list.exec_amt2}'/>" size="10" maxlength="15" alt="<spring:message code="clm.page.msg.manage.amount" htmlEscape="true" />" num /></td>
			    <td class='tL'><input type="text" name="exec_cont_arr" id="exec_cont_arr" class="text_90" value="<c:out value='${list.exec_cont}' escapeXml="false"/>" size="20" maxlength="200" alt="<spring:message code="clm.page.msg.manage.receiveCond" htmlEscape="true" />" /></td>
			    <td class='tC'><input type="text" name="exec_cmpltday_arr" id="exec_cmpltday_arr2<c:out value='${list.rno}'/>" class="text_calendar" readonly="readonly" value="<c:out value='${list.exec_cmpltday}'/>" size="10" alt="<spring:message code="clm.page.msg.manage.compDate" htmlEscape="true" />" /></td>
			    <td class='tL'><input type="text" name="note_arr" id="note_arr<c:out value='${list.exec_seqno}'/>" class="text_90" value="<c:out value='${list.note}' escapeXml="false"/>" size="20" maxlength="300" alt="<spring:message code="clm.page.msg.common.note" htmlEscape="true" />" /></td>
			    <td class='tC'>
			    <span class="btn_all_b" id="btn_com"><span class="save"></span>
			...
			<tr onmouseout="this.className='';" onmouseover="this.className='selected'">
			    ...
			    <td  class='tC'>
			        <c:choose>
				    	...
				    	<c:otherwise>
				      <span class="btn_all_b"><span class="save"></span><a href='javascript:modifyExecution("<c:out value='${list.cntrt_id}'/>","<c:out value='${list.exec_seqno}'/>","<c:out value='${list.exec_status}'/>");'><c:out value='${list.exec_statusnm}'/></a></span>
				    	</c:otherwise>
				    </c:choose>
				    </td>
			    <td class='tC'></td>
	...
	<c:choose>
				...
				<c:when test="${list.exec_status=='C03100'}">
					...
					<tr onmouseout="this.className='';" onmouseover="this.className='selected'" id="tr_<c:out value='${list.exec_seqno}'/>">
					 <!-- <td id='exec_rn'><c:out value='${list.rno}'/></td> //-->
					 <td class='tL'><input type='text' name='exec_itm_arr' id='exec_itm_arr' class='text_90' value="<c:out value='${list.exec_itm}' escapeXml="false"/>" size='20' maxlength='60' alt="<spring:message code="clm.page.msg.manage.exeItm" htmlEscape="true" />" required readonly/></td>
			         <td class='tC'><input type='text' name='exec_plndday_arr' id="exec_plndday_arr<c:out value='${list.rno}'/>" class='text_calendar' readonly='readonly' value="<c:out value='${list.exec_plndday}'/>" size='10' alt="<spring:message code="clm.page.msg.manage.compResDate" htmlEscape="true" />" required /></td>
			         <td class='tL'><input type='text' name='exec_cont_arr' id='exec_cont_arr' class='text_90' value="<c:out value='${list.exec_cont}' escapeXml="false"/>" size='20' maxlength='60' alt='Description' required /></td>
			         <td class='tC'><input type='text' name='exec_cmpltday_arr' id="exec_cmpltday_arr3<c:out value='${list.exec_seqno}'/>" class="text_calendar<c:out value='${list.rno}'/>" readonly='readonly' value="<c:out value='${list.exec_cmpltday}'/>" size='10' alt="<spring:message code="clm.page.msg.manage.compDate" htmlEscape="true" />"  /></td>
			         <td class='tL'><input type='text' name='note_arr' id='note_arr' class='text_90' value="<c:out value='${list.note}' escapeXml="false"/>" size='20' maxlength='300' alt="<spring:message code="clm.page.msg.common.note" htmlEscape="true" />" /></td>
			         <td class='tC'><span class="btn_all_b">
			         
			         <span class="save"></span><a href='javascript:modifyExecution("<c:out value='${list.cntrt_id}'/>"
			    	,"<c:out value='${list.exec_seqno}'/>"
			    	,"<c:out value='${list.exec_status}'/>"
		...
		<c:when test="${list.exec_status=='C03102'}">
			<tr onmouseout="this.className='';" onmouseover="this.className='selected'" id="tr_<c:out value='${list.exec_seqno}'/>">
			    ...
			    <input type="hidden" name="exec_plndday_arr" id="exec_plndday_arr<c:out value='${list.rno}'/>" class="text_calendar" readonly="readonly" value="<c:out value='${list.exec_plndday}'/>" size="10" alt="<spring:message code="clm.page.msg.manage.compResDate" htmlEscape="true" />" required /></td>
			    <td  class='tL'><c:out value='${list.exec_cont}' escapeXml="false"/>
			    <input type="hidden" name="exec_cont_arr" id="exec_cont_arr"<c:out value='${list.rno}'/>" class="text_90" value="<c:out value='${list.exec_cont}'/>" size="20" maxlength="200" alt="Description" /></td>
			    <td class='tC'><input type="text" name="exec_cmpltday_arr" id="exec_cmpltday_arr3<c:out value='${list.rno}'/>" class="text_calendar" readonly="readonly" value="<c:out value='${list.exec_cmpltday}'/>" size="10" alt="<spring:message code="clm.page.msg.manage.compDate" htmlEscape="true" />" /></td>
			    <td class='tL'><input type="text" name="note_arr" id="note_arr<c:out value='${list.exec_seqno}'/>" class="text_90" value="<c:out value='${list.note}' escapeXml="false"/>" size="20" maxlength="300" alt="<spring:message code="clm.page.msg.common.note" htmlEscape="true" />" /></td>
			    <td class='tC'>
			    <span class="btn_all_b" id="btn_com"><span class="save"></span>
...
function newExecution() {
	...
	var html = "<tr onmouseout=\"this.className=\'\';\" onmouseover=\"this.className=\'selected\'\">"
		// +	"<td id=\'exec_rn\'>"+($('#executionTbody tr').length+1)+"</td>"
		 +	"<td><input type=\'text\' name=\'exec_itm_arr\' id=\'exec_itm_arr\' class=\'text_90\' value=\'\' size=\'20\' maxLength=\'60\' alt=\'<spring:message code='clm.page.msg.manage.exeItm' htmlEscape='true' />\' required /></td>"
         +	"<td class=\'tL\'><input type=\'text\' name=\'exec_plndday_arr\' id=\'exec_plndday_arr"+($('#executionTbody tr').length+1)+"\' class=\'text_calendar\' readonly=\'readonly\' value=\'\' size=\'10\' alt=\'<spring:message code='clm.page.msg.manage.compResDate' htmlEscape='true' />\' required /></td>"
         +	"<td class=\'tC\'><input type=\'text\' name=\'exec_amt_arr\' id=\'exec_amt_arr"+($('#executionTbody tr').length+1)+"\' class=\'text_90 tR\' value=\'\' size=\'10\' maxLength=\'18\' alt=\'<spring:message code='clm.page.msg.manage.amount' htmlEscape='true' />\' required onkeyup=\'olnyNum(this)\' style=\'IME-MODE: disabled\' /></td>"
         +	"<td class=\'tL\'><input type=\'text\' name=\'exec_cont_arr\' id=\'exec_cont_arr"+($('#executionTbody tr').length+1)+"\' class=\'text_90\' value=\'\' size=\'20\' maxLength=\'60\' alt=\'<spring:message code='clm.page.msg.manage.sendCond' htmlEscape='true' />\' required /></td>"
         +	"<td class=\'tC\'><input type=\'text\' name=\'exec_cmpltday_arr\' id=\'exec_cmpltday_arr"+($('#executionTbody tr').length+1)+"\' class=\'text_calendar\' readonly=\'readonly\' value=\'\' size=\'10\' alt=\'<spring:message code='clm.page.msg.manage.compDate' htmlEscape='true' />\' /></td>"
         +	"<td class=\'tL\'><input type=\'text\' name=\'note_arr\' id=\'note_arr\' class=\'text_90\' value=\'\' size=\'20\' maxLength=\'300\' alt=\'<spring:message code='clm.page.msg.common.note' htmlEscape='true' />\' /></td>"
         +  "<td class=\'tC\'><span class=\"btn_all_b\"><span class=\"save\"></span><a href=\'javascript:insertExecution("+($('#executionTbody tr').length+1)+",1)\'><spring:message code='clm.page.msg.common.save' /></a></span></td>"
...
function newExecution2() {
	...
	var html = "<tr onmouseout=\"this.className=\'\';\" onmouseover=\"this.className=\'selected\'\">"
		// +	"<td id=\'exec_rn\'>"+($('#executionTbody2 tr').length+1)+"</td>"
		 +	"<td class=\'tL\'><input type=\'text\' name=\'exec_itm_arr\' id=\'exec_itm_arr\' class=\'text_90\' value=\'\' size=\'20\' maxLength=\'60\' alt=\'<spring:message code='clm.page.msg.manage.exeItm' htmlEscape='true' />\' required /></td>"
         +	"<td class=\'tC\'><input type=\'text\' name=\'exec_plndday_arr\' id=\'exec_plndday_arr2"+($('#executionTbody2 tr').length+1)+"\' class=\'text_calendar\' readonly=\'readonly\' value=\'\' size=\'10\' alt=\'<spring:message code='clm.page.msg.manage.compResDate' htmlEscape='true' />\' required /></td>"
         +	"<td class=\'tC\'><input type=\'text\' name=\'exec_amt_arr\' id=\'exec_amt_arr2"+($('#executionTbody2 tr').length+1)+"\' class=\'text_90 tR\' value=\'\' size=\'10\' maxLength=\'18\' alt=\'<spring:message code='clm.page.msg.manage.amount' htmlEscape='true' />\' required onkeyup=\'olnyNum(this)\' style=\'IME-MODE: disabled\' /></td>"
         +	"<td class=\'tL\'><input type=\'text\' name=\'exec_cont_arr\' id=\'exec_cont_arr2"+($('#executionTbody2 tr').length+1)+"\' class=\'text_90\' value=\'\' size=\'20\' maxLength=\'60\' alt=\'<spring:message code='clm.page.msg.manage.receiveCond' htmlEscape='true' />\' required /></td>"
         +	"<td class=\'tC\'><input type=\'text\' name=\'exec_cmpltday_arr\' id=\'exec_cmpltday_arr2"+($('#executionTbody2 tr').length+1)+"\' class=\'text_calendar\' readonly=\'readonly\' value=\'\' size=\'10\' alt=\'<spring:message code='clm.page.msg.manage.compDate' htmlEscape='true' />\' /></td>"
         +	"<td class=\'tL\'><input type=\'text\' name=\'note_arr\' id=\'note_arr\' class=\'text_90\' value=\'\' size=\'20\' maxLength=\'300\' alt=\'<spring:message code='clm.page.msg.common.note' htmlEscape='true' />\' /></td>"
         +  "<td class=\'tC\'><span class=\"btn_all_b\"><span class=\"save\"></span><a href=\'javascript:insertExecution("+($('#executionTbody2 tr').length+1)+",2);\'><spring:message code='clm.page.msg.common.save' /></a></span></td>"
         //+	"<td><span class=\"ico_uncom\">미확인</span></td>"
...
function newExecution3() {
	...
	//	 +	"<td id=\'exec_rn\'>"+($('#executionTbody3 tr').length+1)+"</td>"
		 +	"<td class=\'tL\'><input type=\'text\' name=\'exec_itm_arr\' id=\'exec_itm_arr\' class=\'text_90\' value=\'\' size=\'20\' maxLength=\'60\' alt=\'<spring:message code='clm.page.msg.manage.exeItm' htmlEscape='true' />\' required /></td>"
         +	"<td class=\'tC\'><input type=\'text\' name=\'exec_plndday_arr\' id=\'exec_plndday_arr3"+($('#executionTbody3 tr').length+1)+"\' class=\'text_calendar\' readonly=\'readonly\' value=\'\' size=\'10\' alt=\'<spring:message code='clm.page.msg.manage.compResDate' htmlEscape='true' />\' required /></td>"
         +	"<td class=\'tL\'><input type=\'text\' name=\'exec_cont_arr\' id=\'exec_cont_arr3"+($('#executionTbody3 tr').length+1)+"\' class=\'text_90\' value=\'\' size=\'40\' maxlength=\'60\' alt=\'Description\' required />"
         +	"<input type=\'hidden\' name=\'exec_amt_arr\' id=\'exec_amt_arr3"+($('#executionTbody3 tr').length+1)+"\' class=\'text_90\' value=\'0\' size=\'10\' maxlength=\'15\' /></td>"
         +	"<td class=\'tC\'><input type=\'text\' name=\'exec_cmpltday_arr\' id=\'exec_cmpltday_arr3"+($('#executionTbody3 tr').length+1)+"\' class=\'text_calendar\' readonly=\'readonly\' value=\'\' size=\'10\' alt=\'<spring:message code='clm.page.msg.manage.compDate' htmlEscape='true' />\' /></td>"
         +	"<td class=\'tL\'><input type=\'text\' name=\'note_arr\' id=\'note_arr\' class=\'text_90\' value=\'\' size=\'20\' maxLength=\'300\' alt=\'<spring:message code='clm.page.msg.common.note' htmlEscape='true' />\' /></td>"
         +  "<td class=\'tC\'><span class=\"btn_all_b\"><span class=\"save\"></span><a href=\'javascript:insertExecution("+($('#executionTbody3 tr').length+1)+",3);\'><spring:message code='clm.page.button.save'/></a></span></td>"
         //+	"<td><span class=\"ico_uncom\">미확인</span></td>"
...
*/
function insertExecution(exec_seqno, tab_num) {
    ...
    if(validateForm(frm)){
    	if(confirm("<spring:message code="clm.page.msg.manage.announce147" />")){
    		if($("#exec_plndday_arr"+tab_num+exec_seqno).val() == null || $("#exec_plndday_arr"+tab_num+exec_seqno).val() == ""){
    			alert("<spring:message code="las.mag.error.ask.alert002" />");
    			$("#exec_plndday_arr"+tab_num+exec_seqno).focus();
    			return;
    		}else if($("#exec_amt_arr"+tab_num+exec_seqno).val() == null || $("#exec_amt_arr"+tab_num+exec_seqno).val() == ""){
    			alert("<spring:message code="las.mag.error.ask.alert003" />");
    			$("#exec_amt_arr"+tab_num+exec_seqno).focus();
    			return;
    		}else if($("#exec_cont_arr"+tab_num+exec_seqno).val() == null || $("#exec_cont_arr"+tab_num+exec_seqno).val() == ""){
    			alert("<spring:message code="las.mag.error.ask.alert006" />");
    			$("#exec_cont_arr"+tab_num+exec_seqno).focus();
    			return;
    		}
    		
			var options = {
					url: "<c:url value='/clm/manage/execution.do?method=insertExecution' />",
					type: "post",
					dataType: "html",
					...
					success: function(data) {
						...
						detailBaseExecution(frm.cnsdreq_id.value,frm.cntrt_id.value);
