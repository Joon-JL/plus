...
<%-- 
/**
 * 파  일  명 : ManageSampleContract_l.jsp
 * 프로그램명 : 샘플계약목록
 * 설      명 : 
 * 작  성  자 : 김재원
 * 작  성  일 : 2012.03.14
...
//		alert(display);
	...
	*/ 
	...
	<%}%>
		...
		frm.target = "_self";
		frm.action = "<c:url value='/clm/manage/myContractPop.do?method=listMyContract&status_mode=samplecontract' />";
	    frm.curPage.value = "1";
	    frm.submit();
	}
...
<!-- header -->
<h1><spring:message code="clm.page.msg.manage.samplecontract.title" /></h1>
<!-- //header -->
<div class="pop_area">
	<!-- content -->
								...
								<table class="search_form" style='min-width:700px;'>
									...
									<tr>
									 ...
									 <th><spring:message code="clm.page.field.manageCommon.srchStep" /> / <spring:message code="clm.page.field.manageCommon.srchStatus" /></th>
                                        <td>
                                            <select style='width:103px;' class="srch" name="srch_step" id="srch_step" value="<c:out value='${command.srch_step}'/>">
                                            </select>
                                            /           
                                            <select style='width:70px;' class="srch" name="srch_state"  id="srch_state">
                                            </select>
                                        </td>       
...
<div class="pop_footer">
	<div class="btn_wrap tR" >
		<span class="btn_all_w"><span class="cancel"></span><a href="javascript:close()"><spring:message code="secfw.page.button.close" /></a></span>
	</div>
</div>
