...
$(document).ready(function(){
	...
	tit_Toggle(this,'contract-master');
});
...
//인터페이스작업[SSEMS로 계약정보 보내기] ajax로 리턴
...
function goModify() {
	...
	frm.method.value	= "detailConclusion";
	viewHiddenProgress(true);
	frm.submit();
}
...
function processCancel(){
	if(!confirm("<spring:message code="clm.page.msg.manage.announce174" />")) return;
		...
		<div id="content">
			...
			<!-- title -->
		  	<div class="title_basic03">
				<h4><spring:message code="clm.page.title.contract.consultation.detail.contracttitle"/> <img src="<%=IMAGE%>/btn/btn_down.gif" alt="down" onclick="tit_Toggle(this,'contract-master');"/></h4>
			</div>
			<!-- //title -->
			<!-- tab01 -->
			<div class="t_titBtn">
				<ul class="tab_basic03" id="contractTab">
				...
				<div class="btn_wrap_t03" id="conclusion_btn_list" style="display:none;">
					...
					<span class="btn_all_w"><span class="preview"></span><a href="javascript:openPrint();">
					<c:choose>
						<c:when test="${lomReq.depth_status == 'C02642'}">
							<spring:message code="clm.page.msg.manage.printCover" />
						</c:when>
						<c:otherwise>
							<spring:message code='las.page.button.lawconsult.print' />
						</c:otherwise>
					</c:choose>
					</a></span>&nbsp;
					<span class="btn_all_w"><span class="list"></span><a href="javascript:goList();"><spring:message code='clm.page.button.contract.list' /></a></span>
			...
			<div class="t_titBtn">
				<div class="btn_wrap_c" id="conclusion_btn" style="display:none;">
					<span class="btn_all_w"><span class="list"></span><a href="javascript:goModify();"><spring:message code="clm.page.msg.manage.conclCopyReg" /></a></span>
					<span class="btn_all_w"><span class="reset"></span><a href="javascript:processCancel();"><spring:message code="clm.page.button.contract.rollback2" /></a></span>
					<span id ="id_defer" class="btn_all_w"><span class="defer"></span><a href="javascript:goDefer('deferRequest');"><spring:message code='clm.page.button.contract.defer' /></a></span>
					<span class="btn_all_w"><span class="preview"></span><a href="javascript:openPrint();"><spring:message code='las.page.button.lawconsult.print' /></a></span>
				...
				<div class="btn_wrap_c" id="conclusion_btn_list" style="display:none;">
					<span class="btn_all_w"><span class="preview"></span><a href="javascript:openPrint();">
					<c:choose>
						<c:when test="${lomReq.depth_status == 'C02642'}">
							<spring:message code="clm.page.msg.manage.printCover" />
