	 ...
	 function initPage(){		 
		var frm = document.frm;	
		  ...
		  //frm.submit();
		    ...
		    //표준계약서
		    frm.target          = "fileListStd";
		    frm.action          = "<c:url value='/clms/common/clmsfile.do' />";
		    frm.method.value    = "forwardClmsFilePage";
		    frm.file_bigclsfcn.value = "F003";
		    frm.file_midclsfcn.value = "F00301";
		    frm.file_smlclsfcn.value = "";
		    frm.ref_key.value = $('#master_cnslt_no').val();
		    frm.fileInfoName.value = "fileInfos";
		    frm.fileFrameName.value = "fileListStd";
		  //frm.submit();
		    getClmsFilePageCheck('frm');
		}
...
<div id="wrap">
	...
	<div id="container">
		...
		<h3>
		    ...
		    </c:choose>&nbsp;<c:out value='${lomRq.depth_status_nm}'/></h3>
		<!-- //title -->		
		<!-- content -->	
		<div id="content">		
			   ...
			   <%  } %>
				...
				<% if("C04202".equals(lomRq.get("prgrs_status")) || "C04203".equals(lomRq.get("prgrs_status")) || "C04204".equals(lomRq.get("prgrs_status")) || "C04205".equals(lomRq.get("prgrs_status")) || "C04206".equals(lomRq.get("prgrs_status")) || "C04207".equals(lomRq.get("prgrs_status")) ){	//검토중  회신 일때 Drop 보임%>
					<c:choose>			   			
						...
						<span id ="id_defer" class="btn_all_w"><span class="defer"></span><a href="javascript:actionConsideration('deferRequest');" title="<spring:message code="clm.page.msg.manage.tempConcl" htmlEscape="true" />"><spring:message code="clm.page.msg.manage.delay" /></a></span>
						</c:when>
						<c:otherwise> 
				   		<span class="btn_all_w"><span class="check2"></span><a href="javascript:prevCnsdReqCopyConsideration('again');"><spring:message code="clm.page.msg.manage.reply" /></a></span>
						</c:otherwise>
			...
			<table id="table_requestInfo" cellspacing="0" cellpadding="0" class="table-style01">
				...
				<tr>
					<th class="borTz02"><spring:message code="clm.page.msg.manage.revReqTitle" /></th>
				...
				<tr>
					...
					<td colspan="5"><c:out value="${lomRq.cnsd_demnd_cont}" />
					</td>
				</tr>
...
<%} %>
		   ...
		   <div class="title_basic03">
			...
			<ul id="tab_title" class="tab_basic03">
				...
				<c:otherwise>
					<li id="tab_li<c:out value='${list.rn}'/>"><a href="javascript:titleTabMove('<c:out value='${list.rn}'/>','<c:out value='${list.cntrt_id}'/>');">
					<c:out value='${list.tab_nm}'/></a></li>								
				</c:otherwise>	
				</c:choose>				
				</c:forEach>									
			</ul>			
			<div class="btn_wrap_t03"></div>	
			</div>	
			<!-- 두줄라인 추가 -->
			<div class="tal_topLine"></div>
			<!-- //두줄라인 추가 -->
			<!-- middle table -->
