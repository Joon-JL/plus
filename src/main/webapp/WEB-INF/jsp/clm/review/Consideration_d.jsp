    ...
    <script language="javascript">
		...
		*/
        ...
        function updateRelDPAContract(selectedValue, isInit) {
            ...
            var currentCntrtNo = document.getElementById("has_rel_dpa").value;
        ...
        function forwardConsideration(arg){
			...
			*/
                ...
                var str_msg = "Would like to send a notification to HQ ?";
                if(confirm(str_msg)){

                    //var hq_req_title = "Sending notification to HQ";
                ...
                <div id="content_in">
                    <form:form name="frm" id='frm' method="post" autocomplete="off">
                        ...
                        <div class="btnwrap mt_22">
                            ...
                            <% if(authYN_RA02){ %>
                            <span id="btn_up6" class="btn_all_w" style="display:none" onclick="forwardConsideration('CNSDRESP');" ><span class="reset"></span>
				<spring:message code="las.page.field.contractManager.createReview"/>
				<a><c:choose>
                    <c:when test="${(lomRq.mn_cnsd_dept == command.blngt_orgnz && lomMn.cnsd_status == 'C04302')}">
                        <spring:message code="las.page.field.contractManager.reviewUpdate"/><!--검토수정--></c:when>
                    <c:otherwise><spring:message code="las.page.field.contractManager.createReview"/><!--검토작성--></c:otherwise></c:choose></a></span>
                            <%}%>
                        ...
                        <div id="tr_down02" style="display:none;">
							...
							<c:out value="${lomRq.cntrt_nm}" escapeXml='false'/></span></td>
                                    ...
                                    <input type="hidden" name="cntrt_no" id="cntrt_no" value="<c:out value="${lomRq.cntrt_no}" />" />
                                </tr>
                                <tr>
                            ...
                            <c:choose>
                                <c:when test="${modYn eq 'N' }">
                                    ...
                                    <div id="tr_down_cnsd">
                                        ...
                                        <c:if test="${(lomMn.cnsd_dept == command.blngt_orgnz && lomRq.depth_status == 'C02608') || lomMn.cnsd_status == 'C04305'}">
