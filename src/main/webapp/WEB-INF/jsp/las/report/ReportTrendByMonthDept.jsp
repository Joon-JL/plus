...
<%--
/**
 * 파     일     명 : ReportTrendByMonthDept.jsp
 * 프로그램명 : Trend by 조직
 * 설               명 : 
 * 작     성     자 : 서백진
 * 작     성     일 : 2011.10
...
<title><spring:message code="las.page.title.report.StatisticsContractByTrend2" /></title>
...
<%
		int type=2;
		String mrd = new String(C.process(report_url+"trendByMonthDept.mrd",type));
		String cntrtType = "";
		String dept = "";
		String mrd_param = "";
		String param = "";
...
<div id="wrap">
	...
	<form:form id="frm" name="frm" method="post" autocomplete="off">
		...
		<!-- Title -->
		<div class="title">
		<h3><spring:message code="las.page.title.report.StatisticsContractByTrend2" /></h3>
		</div>
