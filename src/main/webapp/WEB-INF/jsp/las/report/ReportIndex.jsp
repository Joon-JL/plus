...
<%--
/**
 * 파     일     명 : ReportIndex.jsp
 * 프로그램명 : 법무검토LT(누적차트) 조회
 * 설               명 : 
 * 작     성     자 : 
 * 작     성     일 : 2011.10
 */
...
<title><spring:message code="las.page.title.report.StatisticsContractIndex" /></title>
...
<%
		int type=2;
		String mrd = new String(C.process(report_url+"jp1.mrd",type));
		String cntrtType = "";
		String dept = "";
		String mrd_param = "";
		String param = "";
...
<div id="wrap">
	...
	<form:form id="frm" name="frm" method="post" autocomplete="off">
		...
		<input type="hidden" name="transfer" value="J">
		...
		<!-- Title -->
		<div class="title">
		<h3><spring:message code="las.page.title.report.StatisticsContractIndex" /></h3>
		</div>
