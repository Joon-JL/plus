	...
	function save() {
	    ...
	    if(validateForm(frm)){
	    	...
	    	if(confirm("<spring:message code='las.msg.ask.update'/>")){
				...
				frm.action = "<c:url value='/las/lawinformation/guidenedu.do' />";
				frm.method.value = "modifyGuideline";
				frm.target = "_self";
			...
			<table border="0" cellspacing="0" cellpadding="0" class="table-style01">
				...
				<tbody>
					<tr>
						...
						<td>
							<span><input type="text" name="title" id="title" class="text" size="50" value="<c:out value='${lom.title}'/>" maxLength="128" value="" alt="<spring:message code='las.page.field.board.notice.title' />" maxLength="128" required /></span>
						</td>
					</tr>
					<tr class="end">
