	...
	*/
	function pageAction(flag){
		...
		if(flag == "modify"){
		    ...
		    frm.method.value = "modifyMainLawInfo";
...
// 		    frm.body_mime.value = frm.wec.MIMEValue;
	...
	*/
	$(document).ready(function(){
		...
		//분류세팅
	    getCodeSelectByUpCd("frm", "law_gbn", "/common/clmsCom.do?method=listComCdByGrpCd&combo_sys_cd=LAS&combo_abbr=F&combo_grp_cd="+"<c:out value='${command.info_gbn}'/>"+"&combo_type=S&combo_del_yn=N&combo_selected="+"<c:out value='${lom.law_gbn}'/>");
	    getCodeSelectByUpCd("frm", "trgt_nation", "/common/clmsCom.do?method=listComCdByGrpCd&combo_sys_cd=LAS&combo_abbr=F&combo_grp_cd=L2&combo_type=S&combo_del_yn=N&combo_selected="+"<c:out value='${lom.trgt_nation}'/>");
	    getCodeSelectByUpCd("frm", "dmstfrgn_gbn", "/common/clmsCom.do?method=listComCdByGrpCd&combo_sys_cd=LAS&combo_abbr=F&combo_grp_cd=C002&combo_type=S&combo_del_yn=N&combo_selected="+"<c:out value='${lom.dmstfrgn_gbn}'/>");
		
	    <c:if test="${lom.dmstfrgn_gbn=='F'}" >
	    	document.frm.trgt_nation.style.visibility = "visible";
	    </c:if>
...
<%-- 			<input type="hidden" name="body_mime" id="body_mime" value="<c:out value='${lom.cont}' />" /> --%>
			...
			<div class="btnwrap">
				<span class="btn_all_w"><span class="save"></span><a href="javascript:pageAction('modify')"><spring:message code='las.page.button.save' /></a></span>
					...
					<c:choose>
						<c:when test="${command.info_gbn=='C00405' }">
							<tr>
					            ...
					            <td colspan="3">
					            	<input type="text" name="title" id="title" class="text_full" maxLength="64" value="<c:out value='${lom.title}' />" alt="<spring:message code='las.page.field.contract.library.title' />" required />
					            </td>
						...
						<c:when test="${command.info_gbn=='C00406' }">
							<tr>
					            ...
					            <td colspan="5">
					            	<select name="law_gbn" id="law_gbn" alt="<spring:message code="las.page.field.lawinformation.classfy" />" style="width:180px" >
									</select>
					            	<select name=dmstfrgn_gbn id="dmstfrgn_gbn" style="width:80px" onChange="javascript:selectOptions(this)">
									</select>    
							...
							<tr>
								<th><spring:message code="las.page.field.board.notice.title" /></th>
					            <td colspan="5">
					            	<input type="text" name="title" id="title" class="text_full" maxLength="128" value="<c:out value='${lom.title}' />" alt="<spring:message code="las.page.field.contract.library.title" />" required/>
					            </td>
				        	</tr>
				        	<tr>
					            <th><spring:message code="las.page.field.board.notice.reg_nm" /></th>
