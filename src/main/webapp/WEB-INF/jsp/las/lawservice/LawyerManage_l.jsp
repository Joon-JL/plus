...
<script language="javascript">
	...
	$(document).ready(function(){
		...
		// 전문분야
		getCodeSelectByUpCd2("frm", "srch_expert_area", "/common/clmsCom.do?method=listComCdByGrpCd&combo_sys_cd=LAS&combo_grp_cd="+"110"+"&combo_abbr=F&combo_type=S2&combo_use_yn=Y&combo_selected="+"<c:out value='${command.srch_expert_area}'/>");
	
		// 변호사평가
		getCodeSelectByUpCd2("frm", "srch_lwr_estimate_lvl", "/common/clmsCom.do?method=listComCdByGrpCd&combo_sys_cd=LAS&combo_grp_cd="+"C006"+"&combo_abbr=F&combo_type=S2&combo_use_yn=Y&combo_selected="+"<c:out value='${command.srch_lwr_estimate_lvl}'/>");
		
		// 변호사명
		frm.srch_lwr_nm.value = "<c:out value='${command.srch_lwr_nm}'/>";
	...
	*/
	function StReload_partin(index){
		$(partin2).html("<select name='srch_kbn2' id='srch_kbn2' alt=" + "<spring:message code='las.page.field.lawservice.gbn2' />"+ " style='width:92px;' ></select>");
	...
	*/ 
	function pageAction(flag){
		...
		if(flag == "search"){
			...
			frm.target = "_self";
			frm.action = "<c:url value='/las/lawservice/lawyerManage.do' />";
		    frm.method.value = "forwardLawyerManageInsert";
			frm.submit();
		}
	}
...
<div id="container">
	...
	<!-- title -->
	<div class="title">
		<h3><spring:message code="las.page.field.lawservice.lwrmng" /></h3>
	</div>
	<!-- //title -->
	<!-- content -->
	<div id="content">
							...
							<table class="search_form">
								...
								<tr>
									...
									<td colspan=3" >
										...
										<input id="srch_event_nm" name="srch_event_nm" type="text" style="width:150px;" alt="<spring:message code="las.page.field.lawservice.eventnm" />" maxlength="100" />
									</td>
							  </tr>
							  <tr>
									...
									<td colspan=3" >
										...
										<input id="srch_lawfirm_nm" name="srch_lawfirm_nm" type="text" style="width:150px;" alt="<spring:message code="las.page.field.lawservice.lawfirmnm" />" maxlength="100" />
									</td>
							  </tr>
							   <tr>
									...
									<td>
										<select id="srch_expert_area" name="srch_expert_area" style="width:153px;">
										</select>
									</td>
							  </tr>
							  <tr>
									...
									<td>
										<select id="srch_lwr_estimate_lvl" name="srch_lwr_estimate_lvl" style="width:154px;">
										</select>
									</td>
									<th><spring:message code="las.page.field.lawservice.lwrnm" /></th>
									<td>
										<input id="srch_lwr_nm" name="srch_lwr_nm" type="text" style="width:150px;" alt="<spring:message code="las.page.field.lawservice.lwrnm" />" maxlength="64"/>
									</td>
							  </tr>
							</table>
						</td>
		...
		<colgroup>
		  ...
		  <thead>
			<tr>
			  ...
			  <th><spring:message code="las.page.field.lawservice.estmt" /></th>
							...
							<tr onMouseOut="this.className='';" onMouseOver="this.className='selected'">
								...
								<td  class="tL">
									<div style='width:280px;overflow:hidden;text-overflow:ellipsis'>
						            	<nobr><a href='javascript:detailView("<c:out value='${list.lwr_no}'/>");'>
						          		<c:out value='${list.lwr_nm}'/></a></nobr>
						          	</div>
					            </td>
					            <td><c:out value='${list.lwr_estmt_lvl_nm}'/></td>
					            <td><c:out value='${list.lwr_jikgup_nm}'/></td>
