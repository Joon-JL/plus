...
<script language="javascript">
	...
	*/ 
	function pageAction(flag){		
		...
		if(flag == "search"){
		    //유효성 체크
		    if(validateForm(frm) && date_check()){
				viewHiddenProgress(true);				
		    	frm.target = "_self";
				frm.action = "<c:url value='/las/lawservice/eventManage.do' />";
			    frm.method.value = "listEventManage";
			...
			frm.target = "_self";
			frm.action = "<c:url value='/las/lawservice/eventManage.do' />";
		    frm.method.value = "forwardEventManageInsert";
			frm.submit();
		}
	}
	...
	*/ 
	function date_check(){	
		...
		var st_day = $("#srch_start_dt").val();
		var ed_day = $("#srch_end_dt").val();
		
		if((st_day != '') && (ed_day != '')){
			var num_st_day = $("#srch_start_dt").val().replace(/-/gi,'');
			var num_ed_day = $("#srch_end_dt").val().replace(/-/gi,'');
...
<input type="hidden" name="forward_from"  value="0" />
...
<!-- //Location -->	
	<!-- title -->
	<div class="title">
		<h3><spring:message code="las.page.field.lawservice.eventmng" /></h3>
	</div>
	<!-- //title -->
	<!-- content -->
	<div id="content">	
							...
							<table class="search_form">
							  ...
							  <tr>
							   ...
							   <tr>
									...
									<td>
										<input id="srch_lwr_nm" name="srch_lwr_nm" value="<c:out value='${command.srch_lwr_nm}'/>" type="text" style="width:150px;" alt="<spring:message code="las.page.field.lawservice.lwrnm" />" maxlength="64" />
									</td>
							  </tr>
							  <tr>
									<th><spring:message code="las.page.field.lawservice.regnm" /></th>
									<td>
										<input id="srch_reg_nm" name="srch_reg_nm" value="<c:out value='${command.srch_reg_nm}'/>" type="text" style="width:150px;" alt="<spring:message code="las.page.field.lawservice.regnm" />" maxlength="100"/>
									</td>
					...
					<tr onMouseOut="this.className='';" onMouseOver="this.className='selected'">
						...
						<td class="tL">
							<div style='width:280px;overflow:hidden;text-overflow:ellipsis'>
				            	<a href='javascript:detailView("<c:out value='${list.event_no}'/>");'>
