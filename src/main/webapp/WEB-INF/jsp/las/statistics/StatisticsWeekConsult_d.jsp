...
<%--
/**
 * 파     일     명 : StatisticsWeekConsult_d.jsp
 * 프로그램명 : 주간업무(자문) 기본 조회
 * 설               명 : 
 * 작     성     자 : 김재원
 * 작     성     일 : 2011.09
...
<!--[if IE]> <script src="http://html5shiv.googlecode.com/svn/trunk/html5.js"></script> <![endif]--><title><spring:message code="las.page.field.board.weekSchedule.header" /></title>
...
<div id="wrap">
	<div id="container">
		...
		<ul class="tab_basic">
			...
			<li class="on"><a href="javascript:moveTab('2');"><spring:message code="las.page.field.statistics.consult" /></a></li>
		...
		<div class="t_titBtn">
			<div class="Sel_aw fL">
	  			<select name="result_yn" id="result_yn" onchange="javascript:moveTab('2')" style="width:100px;">
			...
			<div class="search_box_inner">
				<table class="search_tb">
						...
						<table class="search_form">   
							...
							<td>
			    			<select name="year" id="year" class="select" onchange="javascript:moveTab('2')">
			    			<%
			    			...
			    			<select name="weekseq" id="weekseq" class="select" onchange="javascript:moveTab('2')">		
...
<%
		...
		<table border="0" cellspacing="0" cellpadding="0" class="table-style01 mt20">
			...
			<tr>
				...
				<td><%=(lom != null && lom.size() > 0)?lom.get("title"):"" %></td>
				...
				<input type="hidden" id='weekdutyyns' name='weekdutyyns' value='<%=lom.get("weekdutyyn") %>'>				
			...
			<tr>
				<td align="left" colspan="3">
	    			...
	    			<!--  <textarea name="conts" readonly rows="14" cols="170" class="text_area_full" ><%=(lom != null && lom.size() > 0)?lom.get("reCont"):"" %></textarea>-->
