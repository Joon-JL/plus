...
<script language=javascript>
    ...
    function search() {
    	...
    	f.method.value = "listStatisticsLawCnslt" ;
...
<div id="wrap">
    ...
    <!-- title -->
    <div class="title">
        <h3><spring:message code='las.page.field.statistics.contract03'/></h3><!-- 전사자문현황 -->
    </div>
    <!-- //title -->
        ...
        <div id="content">
	        ...
	        <input type="hidden" name="srch_gbn" id="srch_gbn"  value="L" >
                ...
                <div class='tbl_wrap'>
	                <table class="list_basic">
	                    ...
	                    <tr>
	                        ...
	                        <th rowspan="2"><spring:message code="las.page.field.statistics.total"/></th>	                        
 							<th colspan="<c:out value="${title_colspan }"/>"><spring:message code="las.page.field.statistics.legalConsult"/></th><!-- 법률자문 -->
	                    </tr>
	                    <tr>
	                    	<c:forEach var="list" items="${title_list }" varStatus="status">
					...
					%>
		                        <tr>
		                            ...
		                            <td class="<%if(i==0){%>total <%}%>tR" id="total_<%=i%>"><%=StringUtil.commaIn(String.valueOf(rowMap.get("total_cnt"))) %></td>
					<%      for(int j=0; j<listCol.size(); j++){ 
					            Map colMap = (Map)listCol.get(j) ;
					%>
		                            <td class="<%if(i==0){%>total <%}%>tR" id="<%=colMap.get("cd")%>_<%=i%>">
