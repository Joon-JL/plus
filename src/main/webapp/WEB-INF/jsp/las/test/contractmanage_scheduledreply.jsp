...
<div id="container">
<!-- location -->
<div class="location"><img src="<%=IMAGE%>/icon/ico_home.gif" border="0" alt="Home"> 계약관리 > 계약검토 > <strong>체결 예정본 회신</strong></div>
<!-- //location -->
	<!-- content -->
	<div id="content">
		<!-- title -->	
		<div class="title">
			<h3 class="h3_mz">체결 예정본 회신</h3>
		</div>		
		<!-- //title -->
		<div class="t_titBtn">
			<!-- title -->
		...
		<table cellspacing="0" cellpadding="0" class="table-style01 borz01" id="tr_down01" style="display:block;">
			...
			<tr>
				<th>변경내역 및<br />사유</th>
				 <td colspan="5"><textarea name="textarea" id="textarea" cols="40" rows="3" class="text_area_full">정보생성주체:의뢰인</textarea></td>
			</tr>
			<tr class="end">
				<th>첨부파일</th>
				<td colspan="5">
		...
		<div class="tal_subBox" id="tr_down02" style="display:block;">
			...
			<table cellspacing="0" cellpadding="0" border="0" class="table-style01">
				...
				<tr>
					...
					<td colspan="4">
						<select>
						<option>당사 지급액의 2배</option>
						</select>
					</td>
				</tr>
				<tr>
					<th>Spectial<br />Condition</th>
					<td colspan="4">
				...
				<tr>
					...
					<td colspan="4">
						...
						<span style="padding-left:50px;">
							<span class="btn_option"><span class="arrow"></span><a href="#">법무장반려</a></span>
						</span>
					</td>
				</tr>
				<tr>
					<th>그룹장<br />반려사유</th>
					<td colspan="4">
						<textarea name="textarea" id="textarea" cols="30" rows="3" class="text_area_full">로열티 지급 누락액에 상세부연설명하시오.</textarea>
					</td>
				</tr>
				<tr>
					<th>최종확인자</th>
					<td colspan="2">이법무그룹장</td>
					<th>최종확인일</th>
					<td>
						2011-08-20
					</td>
				...
				<tr>
					<th>프로젝트명<br />적용대상 제품</th>
					<td colspan="2">Orion2</td>
					<th>라이선스 범위<br />및 조건</th>
					<td>
						<textarea name="textarea" id="textarea" cols="30" rows="3" class="text_area_full"></textarea>
					</td>
				</tr>
				...
				<tr>
					<th>Warranty/<br />Indemnitication</th>
					<td colspan="4">
						<textarea name="textarea" id="textarea" cols="30" rows="3" class="text_area_full">당사가 개발, 외주개발, 생산, 외주 생산하는 전제품에 적용하여 제품을 판매할 수 있는 비독점적, 전세계적...</textarea>
					</td>
				</tr>
				<tr>
					<th>준거법</th>
