		...
		if(frm.title.value == ""){
	    	...
	    	if(confirm(msg)){
	    		...
	    		fileList.UploadFile(function(uploadCount){
				    ...
				    //frm.body_mime.value = frm.wecKr.MIMEValue;
					//frm.body_mime_en.value = frm.wecEn.MIMEValue;
		...
		<!-- *********************** Form setting *************************** -->
			...
			<table border="0" cellspacing="0" cellpadding="0" class="table-style01">
				...
				<tbody>
					...
					<tr>
						<th><spring:message code='las.page.field.board.notice.titleEn' /></th>
						<td colspan="3">
					  		<span><input type="text" name="title_en" id="title_en" class="text" style="width:600px;" maxLength="128" value="" alt="<spring:message code='las.page.field.board.notice.titleEn' />" maxLength="64" required /></span>
						</td>
					</tr>
					...
					<tr>
						...
						<td colspan="3">
						    <textarea  id="namo_cntnt" name="namo_cntnt" style="display:none;" rows="" cols=""></textarea>
							<%@ include file="/WEB-INF/jsp/common/CrossEditInclude.jspf"%>
						</td>
					</tr>
					<tr>
