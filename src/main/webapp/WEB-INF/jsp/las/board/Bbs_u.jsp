		...
		<table border="0" cellspacing="0" cellpadding="0" class="table-style01">
			...
			<tbody>
	        	<tr>
		            ...
		            <td colspan="3">
		            	<span><input type="text" name="title" id="title" class="text" style="width:600px;" maxLength="256" value="<c:out value="${lom.title}" escapeXml="false"/>" alt="<spring:message code="las.page.field.board.notice.title"/>" maxLength="64" required /></span>
		            </td>
	        	</tr>
	        	<tr>
	        	...
	        	<tr>
					...
					<td colspan="3">
						<!-- textarea name="cont" id="cont" cols="45" rows="20" class="text all"></textarea-->
						...
						<script type="text/javascript" language="javascript">
	        					...
	        					function OnInitCompleted(e){
	        						CrossEditor.SetValue(document.frm.cont.value);
	        					}
                            </script>  
					</td>
				</tr>
