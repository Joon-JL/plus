...
<%
	...
	if(encrypt.equals(u_pass))
	{
			...
			{
				session.invalidate(); 
				result_sc = "<script>alert(ce_bh.ce_lW); window.document.location.href='../index.html';</script>";
			}
			else
			{
		...
		result_sc = "<script>alert(ce_bh.ce_lm);location.href='account_setting.jsp';</script>";
	}
