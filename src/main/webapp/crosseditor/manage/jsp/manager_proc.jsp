...
<%
	...
	if(check){
		result_sc = "<script type='text/javascript' language='javascript'>alert(ce_bh.ce_lW); window.document.location.href='manager_setting.jsp?Tab=" + request.getParameter("Tab") + "';</script>";
	}
	else{
		result_sc = "<script>alert(ce_bh.ce_if+'" + fileName + "');  history.back();</script> ";
	}
...
<% 
	...
	result_sc = URLDecoder.decode(result_sc.toString(), "UTF-8");
