...
$(document).ready(function(){
	...
	function goInsertForm() {
		...
		frm.method.value = "forwardInsertSubject";
		frm.action = "<c:url value='/clm/admin/subject.do' />";
		frm.target = "_self";
		viewHiddenProgress(true);
		frm.submit(); 
	...
	function goDetail(type_cd) {
	    ...
	    frm.method.value = "detailSubject";
		frm.action = "<c:url value='/clm/admin/subject.do' />";
		frm.target = "_self";
		viewHiddenProgress(true);
		frm.submit();
	...
	<div id="container">
		...
		<div id="content_in">
						...
						<tr>
							<td>
								<table class="search_form">
									...
									<tr>
										<th>
											<spring:message code="clm.page.field.admin.subject.cntr_cd" /></th>
										</th>
										<td>
			...
			<table class="list_basic">
				...
				<thead>
					<tr>
	            		<th><spring:message code="clm.page.field.admin.subject.no" /></th>			<!-- No -->
	            		<th><spring:message code="clm.page.field.admin.subject.dimension" /></th>	<!-- 분류명(Dimension) -->
	            		<th><spring:message code="clm.page.field.admin.subject.detail" /></th>		<!-- 상세 -->
	            		<th><spring:message code="clm.page.field.admin.subject.reg_dt" /></th>		<!-- 등록일 -->
	            		<th><spring:message code="clm.page.field.admin.subject.registrant" /></th>	<!-- 등록자 -->
					</tr>
				</thead>
				<tbody>
					<tr>
