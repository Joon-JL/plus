	...
	<div id="container">
		...
		<div id="content">
			...
			<div id="content_in">				
				<form:form name="frm" id='frm' method="post" autocomplete="off">
					...
					<div class="btnwrap mt_22">
						...
						<!-- HQ REQUEST 버튼 상단 -->
						<span id="btn_up20" style="display:none"> <span  class="btn_all_w" onclick="forwardConsideration('EMAIL-TO-HQ');" ><span class="mail"></span><a>Send notification to HQ</a></span></span>
						<span id="btn_up20disabled" style="display:none"> <span  class="btn_all_w" onclick="forwardConsideration('HQ');" ><span class="mail"></span><a><spring:message code="las.page.field.hqrequest.page17"/></a></span></span><!-- REQUEST TO HQ -->
						<span id="btn_up21disabled" class="btn_all_w" style="display:none" onclick="forwardConsideration('REHQ');" ><span class="mail"></span><a><spring:message code="las.page.field.hqrequest.page18"/></a></span><!-- REQUEST TO HQ 재의뢰-->
							...
							<c:forEach var="list_in" items="${list.HQ_LIST}" varStatus="x">			
								<c:choose>
									...
									<c:when test="${'ADMIN_REPLY' eq list_in.cont_type }">	
										<c:set var="cont_lavel1"  value="HQ ADMIN REPLY"/>
									</c:when>
									<c:otherwise>
										<c:choose>
			...
			<div class="btn_wrap_c">
				...
				<!-- HQ REQUEST 버튼 하단 -->
				<span id="btn_down20" style="display:none"> <span  class="btn_all_w" onclick="forwardConsideration('EMAIL-TO-HQ');" ><span class="mail"></span><a>Send notification to HQ</a></span></span>
			    <span id="btn_down20disabled" style="display:none"><span class="btn_all_w" onclick="forwardConsideration('HQ');" ><span class="mail"></span><a><spring:message code="las.page.field.hqrequest.page17"/></a></span></span><!-- REQUEST TO HQ -->
			    <span id="btn_down21disabled" class="btn_all_w" style="display:none" onclick="forwardConsideration('REHQ');" ><span class="mail"></span><a><spring:message code="las.page.field.hqrequest.page18"/></a></span><!-- REQUEST TO HQ 재의뢰-->
