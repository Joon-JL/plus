...
<%--
/**
 * 파     일     명 : ConsultationApprovalPrint_p.jsp
 * 프로그램명 : 품의서출력
 * 설               명 : 
 * 작     성     자 : 서백진
 * 작     성     일 : 2011.09
...
<title><spring:message code="clm.page.msg.manage.printItm" /></title>
...
<div id="wrap">
	...
	<form:form id="frm" name="frm" method="post" autocomplete="off">
		...
		<!-- Title -->
		<div class="title">
		<h3><a href="#"><spring:message code="clm.page.title.contract.consultation.rdviewer" /></a></h3>
		</div>
		...
		<td height="600px" >
			...
			<script>	
			  	...
			  	if(langCd.startsWith("ko")){
			  		rdOpen("<c:out value='${command.report_url}'/>"+"/report/contract_agree.mrd", parm , "", 100);
			  	}
			  	else{
			  		rdOpen("<c:out value='${command.report_url}'/>"+"/report/en_contract_agree.mrd", parm , "", 100);
			  	}
