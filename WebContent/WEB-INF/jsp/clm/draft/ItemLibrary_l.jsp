...
<script language="javascript">
	...
	*/
	function goPage(pgNum){
		...
		frm.method.value = "listItemLibrary";
	...
	*/ 
	function pageAction(flag){
		...
		if(flag == "search"){
		    ...
		    frm.method.value = "forwardInsertItemLibrary";
			frm.submit();
		}
	}
...
<div id="wrap">
	...
	<div id="container">
		...
		<!-- Title -->
		<div class="title">
			<h3><spring:message code="clm.page.title.itemlibrary.listTitle" /></h3>
		</div>
		<!-- //title -->
						...
						<tr>
							<td>
								<table class="search_form">
									...
									<tr>
										<th><spring:message code="clm.page.field.itemlibrary.srchBizClsfcn" /></th>
										<td>
											<select name="srch_biz_clsfcn" id="srch_biz_clsfcn">
											</select>
										</td>
										<th><spring:message code="clm.page.field.itemlibrary.srchCnclsnpurpsClsfcn" /></th>
								    	<td colspan="3">
									...
									<tr>										
										<th><spring:message code="clm.page.field.itemlibrary.srchDepthClsfcn" /></th>
										<td>
											<select name="srch_depth_clsfcn" id="srch_depth_clsfcn">
											</select>
										</td>
										<th><spring:message code="clm.page.field.itemlibrary.srchLangGbn" /></th>
										<td>
											<select name="srch_lang_gbn" id="srch_lang_gbn">
											</select>								
										</td>
										<th><spring:message code="clm.page.field.itemlibrary.srchKeyword" /></th>
										<td>
											<select name="srch_keyword" id="srch_keyword">
								           	  <option value="title" default <c:if test="${command.srch_keyword eq 'title'}">selected</c:if>><spring:message code="clm.page.field.itemlibrary.srchTitle" /></option>
								           	  <option value="reg_nm"  <c:if test="${command.srch_keyword eq 'reg_nm'}">selected</c:if>><spring:message code="clm.page.field.itemlibrary.srchRegNm" /></option>
								        	</select>
		...
		<%} %>
			...
			<table border="0" cellspacing="0" cellpadding="0" class="list_basic">
				<colgroup>
			  	...
			  	<thead>
					<tr>
						<th><spring:message code="clm.page.field.itemlibrary.no" /></th>
						...
						<th><spring:message code="clm.page.field.itemlibrary.title" /></th>
						<th><spring:message code="clm.page.field.itemlibrary.regNm" /></th>
						<th><spring:message code="clm.page.field.itemlibrary.regDt" /></th>
					</tr>
				</thead>
			 	<tbody>
