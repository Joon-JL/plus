...
<!-- 담당자일 경우 -->
<c:choose>
	<c:when test="${compeltionCommand.session_user_id==completionLom.cntrt_respman_id && ( completionLom.depth_status=='C02662' || completionLom.depth_status=='C02681' ) }">
...
%>
		<tr>
			<th ><spring:message code="clm.page.msg.manage.statChg" />
</th>
			<td colspan="5">
				<input title="<spring:message code="clm.page.msg.manage.announce044" htmlEscape="true" />"  type="radio" name="cntrt_status" id="cntrt_status" size="50" value="C02404" <c:if test="${completionLom.cntrt_status=='C02404'}" >checked</c:if> /><strong style="padding: 0px 30px 0px 5px" title="<spring:message code="clm.page.msg.manage.announce044" htmlEscape="true" />" ><spring:message code="clm.page.msg.manage.endOfDate" />  </strong>
				...
				<input title="<spring:message code="clm.page.msg.manage.announce040" htmlEscape="true" />" type="radio" name="cntrt_status" id="cntrt_status" size="50" value="C02405" <c:if test="${completionLom.cntrt_status=='C02405'}">checked</c:if>/><strong style="padding: 0px 30px 0px 5px" title="<spring:message code="clm.page.msg.manage.announce040" htmlEscape="true" />" ><spring:message code="clm.page.msg.manage.calncel" />  </strong>
			</td>
		</tr>
		<tr>
