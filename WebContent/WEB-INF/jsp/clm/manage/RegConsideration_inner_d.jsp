...
<%--
/**
 * 파  일  명 : RegConsideration_inner_d.jsp
 * 프로그램명 : 체결 후 등록 상세 조회
 * 설      명 : 
 * 작  성  자 : chahyunjin
 * 작  성  일 : 2011.08
...
%>	
<!-- page name: RegConsideration_inner_d.jsp -->
			...
			<input type="hidden" name="file_validate" id="file_validate" value="<c:out value='${command.file_validate}'/>">
			   <colgroup>
				...
				<tr class="slide-target02 slide-area">
					...
					<%	if("Y".equals(lomRq.get("plndbn_req_yn")) && "C02608".equals(lomRq.get("depth_status"))){ //최종본의뢰여부%>					
					<th><spring:message code="clm.page.msg.manage.noAttach" /></th>
					<td><c:out value="${lomRq.auto_rnew_yn}" /></td>				
					<% }%>					
				</tr>
				<tr class="slide-target02 slide-area">
					<th colspan="2"><spring:message code="clm.page.msg.manage.autoExpYn" /></th>
					<td colspan="2">
