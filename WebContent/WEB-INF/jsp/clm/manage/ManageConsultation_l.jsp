...
<%-- 
/**
 * 파  일  명 : ManageConsultation_l.jsp
 * 프로그램명 : 계약체결목록
 * 설      명 : 
 * 작  성  자 : 박정훈
 * 작  성  일 : 2013.04
...
<script language="javascript">
	$(document).ready(function(){
		...
		getCodeSelectByUpCd("frm", "srch_state", '/common/clmsCom.do?method=listComCdByGrpCd&combo_sys_cd=CLM&combo_abbr=F&useman_mng_itm1=' + '<c:out value='${command.srch_step}'/>' +'&combo_type=T&combo_del_yn=N&combo_selected='+'<c:out value='${command.srch_state}'/>');
		//비즈니스 단계 
...
//		alert(display);
	...
	*/
	...
	function ConsultationGuidePop(){
		...
		frm.forward_url.value="/step02.html";
		frm.submit();
	}
</script>
</head>
...
<div id="wrap">
	...
	<div id="container">
		...
		<!-- Title -->
		<div class="title">
			<h3><spring:message code="clm.page.title.manageConsultation.listTitle" /></h3>
		</div>
		<!-- //title -->
		...
		<div id="content">
			...
			<!-- tab -->
		  	<div class="tab_box">
		        ...
		        <span style="float:right;"><!-- <a href="javascript:ConsultationGuidePop();"> --><a href="javascript:open_window('win', '../../step02<%=langCd.equals("ko")?"":"_"+langCd %>.html', 0, 0, 696, 588, 0, 0, 0, 0, 0)"><img src="<%=IMAGE%>/btn/btn_quick.gif" alt="Quick Guide"/></a></span>
			</div>
			<!-- //tab -->
