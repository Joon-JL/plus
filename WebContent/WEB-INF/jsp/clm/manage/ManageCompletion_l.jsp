...
//		frm.cnsdreq_id.value = "20110914111640614";		
		frm.submit();
	}
	...
	*/
	...
	function CompletionGuidePop(){
		...
		frm.forward_url.value="/step05<%=langCd.equals("ko")?"":"_"+langCd %>.html";
		frm.submit();
	}
...
<div id="wrap">
	...
	<div id="container">
		...
		<!-- Title -->
		<div class="title">
			<h3><spring:message code="clm.page.title.manageCompletion.listTitle" /></h3>
		</div>
		<!-- //title -->
		...
		<div id="content">
			<!-- tab -->
		  	<div class="tab_box">
		        ...
		        <span style="float:right;"><!-- <a href="javascript:CompletionGuidePop();"> --><a href="javascript:open_window('win', '../../step05<%=langCd.equals("ko")?"":"_"+langCd %>.html', 0, 0, 696, 588, 0, 0, 0, 0, 0)"><img src="<%=IMAGE%>/btn/btn_quick.gif" alt="Quick Guide"/></a></span>
			</div>
			<!-- //tab -->
