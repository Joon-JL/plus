...
function pageAction(div){
	...
	if(div == "search"){		
		...
		frm.method.value = "listSignUserMng";
		frm.submit();
		frm.target = "_self";
...
<div id="wrap">
	...
	<!-- title -->
	<div class="title">
		<h3><spring:message code="secfw.page.field.user.signContMg"/></h3>
	</div>
	<!-- //title -->		
	...
	<div id="content">
     ...
     <table class="list_basic mt20">
			...
			<!-- 날인담당자관리,증명서류발급자관리텍스트입력폼 -->
			<tr>
				<th class='head'><spring:message code="clm.page.field.sign.corp"/><!-- 관리사업장--></th>
	          	<td><input type="text" name='ara_nm' id='ara_nm' class="text w_50"  maxlength="33" ></td>
			</tr>
			<tr>
