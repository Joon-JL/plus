...
<title><spring:message code="las.page.title.report.StatisticsContractProcess" /></title>
...
<%
		int type=2;
		String mrd = new String(C.process(report_url+"process.mrd",type));
		String prcs_gbn = "";
		String dept = "";
		String mrd_param = "";
		String param = "";
		...
		if(statisticsForm.getSrch_prcs() != null && statisticsForm.getSrch_prcs().equals("C")){
			prcs_gbn="C";
		}else{
			prcs_gbn="B";
		}
...
<div id="wrap">
	...
	<form:form id="frm" name="frm" method="post" autocomplete="off">
		...
		<!-- Title -->
		<div class="title">
		<h3><spring:message code="las.page.title.report.StatisticsContractProcess" /></h3>
		</div>
							...
							<table class="search_form">
								...
								<tr>
								    ...
								    <select name="cntrtType" id="cntrtType"  style='width:80'></select>
		    	        		     ...
		    	        		     -->	
		    	        		    <th><spring:message code="las.page.field.report.Processgubun" /></th>
		    	        		    <td>
								    <select name="srch_prcs" id="srch_prcs"  style='width:80'>
								    <option value='B' <%=(statisticsForm.getSrch_prcs() != null && statisticsForm.getSrch_prcs().equals("B")?"selected":"") %>><spring:message code="las.page.field.report.mtStandard"/></option>
								    <option value='C' <%=(statisticsForm.getSrch_prcs() != null && statisticsForm.getSrch_prcs().equals("C")?"selected":"") %>><spring:message code="las.page.field.report.signStnd"/></option>
								    </select>
		    	        		    </td> 		    	        		     	    	        		    										
								</tr>
							</table>
