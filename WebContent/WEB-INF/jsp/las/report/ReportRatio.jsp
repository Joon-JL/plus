...
<title><spring:message code="las.page.title.report.StatisticsContractRatio" /></title>
...
<%
		int type=2;
		String mrd = new String(C.process(report_url+"jp2.mrd",type));
		String cntrtType = "";
		String dept = "";
		String mrd_param = "";
		String param = "";
...
<div id="wrap">
	...
	<form:form id="frm" name="frm" method="post" autocomplete="off">
		...
		<!-- Title -->
		<div class="title">
		<h3><spring:message code="las.page.title.report.StatisticsContractRatio" /></h3>
		</div>
