...
// 				    frm.body_mime.value = frm.wec.MIMEValue;
					...
					frm.action = "<c:url value='/las/lawinformation/guidenedu.do' />";
					frm.method.value = "insertGuidenedu";
					frm.target = "_self";
			...
			<table border="0" cellspacing="0" cellpadding="0" class="table-style01">
				...
				<tbody>
					<tr>
						...
						<td colspan="3">
					  		<span><input type="text" name="title" id="title" class="text_full" maxLength="128" value="" alt="<spring:message code='las.page.field.board.notice.title' />" maxLength="64" required /></span>
						</td>
					</tr>
					<tr>
