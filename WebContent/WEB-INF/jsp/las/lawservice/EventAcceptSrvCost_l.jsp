...
<%--
/**
 * 파  일  명 : EventAcceptSrvCost_l.jsp
 * 프로그램명 : 용역비 목록
 * 설      명 : 
 * 작  성  자 : 박병주
 * 작  성  일 : 2011.09
...
<input type="hidden" name="forward_from"  value="1" />
...
<!-- //Location -->	
	<!-- title -->
	<div class="title">
		<h3><spring:message code="las.page.field.lawservice.srvcost"/></h3>
	</div>
	<!-- //title -->
	<!-- content -->
	<div id="content">
						...
						<colgroup>
							...
							<table class="search_form">
							   ...
							   <tr>
									...
									<th><spring:message code="las.page.field.lawservice.sortorder"/></th>
									<td>
										<select id="srch_order_type" name="srch_order_type" style="width:154px;" >
											<option value="S_EVENT_NM" <c:if test="${command.srch_order_type == 'S_EVENT_NM'}"> selected </c:if> ><spring:message code="las.page.field.lawservice.eventnm" />&nbsp;<spring:message code="las.page.field.lawservice.orderby"/></option>
											<option value="S_REG_DT" <c:if test="${command.srch_order_type == 'S_REG_DT'}"> selected </c:if> ><spring:message code="las.page.field.lawservice.acptday" />&nbsp;<spring:message code="las.page.field.lawservice.orderby"/></option>
										</select>	
									</td>
							  </tr>
							  <tr>
							...
							<tr onMouseOut="this.className='';" onMouseOver="this.className='selected'">
								...
								<td class="tL">
									<div style='width:280px;overflow:hidden;text-overflow:ellipsis'>
						            	<nobr><a href='javascript:detailView("<c:out value='${list.event_no}'/>");'>
