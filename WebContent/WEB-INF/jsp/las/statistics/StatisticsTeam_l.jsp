...
<!--
	...
	*/
	...
	<%
		...
		String mrd = "StatisticsDept_l.mrd"; 
		String mrd_param = "";
		String param = "";
		mrd_param = 
...
<form:form id="frm" name="frm" method="post" autocomplete="off">
	...
	<!-- content -->
		<!-- Title -->
		<div class="title">
		<h3><spring:message code="las.page.title.statistics.StatisticsDept" /></h3>
		</div> 		
	<div id="content">
	...
	%>
	          <tr>
			    ...
			    <td><%=lom.get("dmstfrgn_gbn").equals("H")?"국내":"해외" %></td>
