...
<%--
/**
 * 파     일     명 : StatisticsMonthConsult_d.jsp
 * 프로그램명 : 월간업무(자문) 기본 조회
 * 설               명 : 
 * 작     성     자 : 서백진
 * 작     성     일 : 2011.09
			...
			<div class="search_box_inner">
				<table class="search_tb">
						...
						<table class="search_form">
	    	        		...
	    	        		<td>
			    			<select name="srch_regdt1" id="srch_regdt1" class="select" onchange="javascript:moveTab('2')">
			    			<%
			    			...
			    			<select name="srch_regdt2" id="srch_regdt2" class="select" onchange="javascript:moveTab('2')">		
	...
	%>		
		...
		<table border="0" cellspacing="0" cellpadding="0" class="table-style01 mt20">
			...
			<tr>
				...
				<td colspan="3"><%=(lom != null && lom.size() > 0)?lom.get("dept_nm"):"" %></td>				
			</tr>
			<tr>
...
<div class="t_titBtn" align="center">
	<span class="tC" style="align:center;" ><spring:message code="las.msg.succ.noResult" /></span>
</div>
