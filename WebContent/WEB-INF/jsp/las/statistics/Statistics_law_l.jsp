...
<div id="wrap">
    ...
    <!-- title -->
    <div class="title">
        <h3><spring:message code="las.page.field.statistics.lgTeamStats"/></h3>
    </div>
    <!-- //title -->
...
<%  } %>                                            </select> <spring:message code="las.page.field.statistics.mm"/>
                ...
                <div class='tbl_wrap'>
                    <table class="list_basic">
                        ...
                        <tr>
                            <th rowspan="2" class='rightline'><spring:message code="las.page.field.statistics.law.title"/></th><!-- Legal<br>Team -->
                        ...
                        <c:forEach var="list" items="${result_list }" varStatus="t">
                            ...
                            <tr>
                                <td class='tC'><c:out value="${list.req_dept }"/></td><!-- 담당자 -->
