...
<%-- 
/**
 * 파  일  명 : Statistics_consultation_l.jsp
 * 프로그램명 : 계약체결건수 통계화면 
 * 설      명 : 관련사통계 계약체결 건수 통계 조회 화면
 * 작  성  자 : 홍성범
 * 작  성  일 : 2013.07
 */
--%>
...
<title><spring:message code="las.page.field.statistics.consultation" text="noMsg"/></title>
...
<script language=javascript>
 $(document).ready(function(){
    ...
    function search() {
    	...
    	var f = document.frm ;
    	f.method.value = "listStatisticsConsultation" ;
...
<div id="wrap">
    ...
    <!-- title -->
    <div class="title">
        <h3><spring:message code="las.page.field.statistics.consultation" text="noMsg"/></h3>
    </div>
    <!-- //title -->
        ...
        <div id="content">
        	<div id="content_in">
                        ...
                        <table class="search_tb">
                            ...
                            <tr>
                                <td>
					    			...
					    			<input type="hidden" name="gubun" id="gubun" value="<c:out value="consultation"/>"/>
                                    ...
                                    <table class="search_form">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form:select path="srch_year" >
	                                                <form:options items="${ylist}"/>
                                                </form:select>
                                            </td>
                                            <th id="wTab"><spring:message code="las.page.field.statistics.weekNo"/></th>
                                            <td id="wTab2">
                ...
                <div class="btnwrap tR">
                    <span class="btn_all_w"><span class="excel_down"></span><a href="javascript:excelDownload1();"><spring:message code="las.page.field.statistics.excelDw"/></a></span>
                </div>
                <!-- // btn -->
                ...
                <div class="ico_alert01 mt10 fR"><spring:message code="las.page.field.statistics.firstContStand"/></div>
            </div>
			<!-- //content_in -->
        </div>
        <!-- //content -->
